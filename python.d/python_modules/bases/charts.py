...
RUNTIME_CHART_CREATE = "CHART hibenchmarks.runtime_{job_name} '' 'Execution time for {job_name}' 'ms' 'python.d' " \
                       "hibenchmarks.pythond_runtime line 145000 {update_every}\n" \
