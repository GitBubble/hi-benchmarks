...
// example configuration in hibenchmarks/conf.d/node.d/stiebeleltron.conf.md
...
var stiebeleltron = {
    ...
    serviceExecute: function (name, uri, update_every) {
        ...
        var service = hibenchmarks.service({
            name: name,
            request: hibenchmarks.requestFromURL(uri),
    ...
    configure: function (config) {
        ...
        while (pageCount--) {
            ...
            if (stiebeleltron.isUndefined(page.categories) || page.categories.length < 1) {
                hibenchmarks.error("Your Stiebel Eltron config is invalid. Disabling plugin.");
                return 0;
            }
