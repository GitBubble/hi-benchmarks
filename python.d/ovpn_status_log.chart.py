# -*- coding: utf-8 -*-
# Description: openvpn status log hibenchmarks python.d module
# Author: l2isbad
...
class Service(SimpleService):
    ...
    def check(self):
        ...
        if not data:
            self.error('Make sure that the openvpn status log file exists and hibenchmarks has permission to read it')
            return None
