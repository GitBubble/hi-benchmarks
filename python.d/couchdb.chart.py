# -*- coding: utf-8 -*-
# Description: couchdb hibenchmarks python.d module
...
class Service(UrlService):
    ...
    def _get_overview_stats(self, queue, url, stats):
        ...
        data = loads(raw_data)
        to_hibenchmarks = self._fetch_data(raw_data=data, metrics=stats)
        if 'message_queues' in data:
            to_hibenchmarks['peak_msg_queue'] = get_peak_msg_queue(data)
    ...
    def _get_dbs_stats(self, queue, url, stats):
        ...
        for db in self.dbs:
            ...
            for metric in stats:
                ...
                to_hibenchmarks[metric_name] = value
        return queue.put(to_hibenchmarks)
