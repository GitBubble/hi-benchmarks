...
/*global hibenchmarksNoDygraphs           *//* boolean,  disable dygraph charts
 *                                                  (default: false) */
/*global hibenchmarksNoSparklines         *//* boolean,  disable sparkline charts
 *                                                  (default: false) */
/*global hibenchmarksNoPeitys             *//* boolean,  disable peity charts
 *                                                  (default: false) */
/*global hibenchmarksNoGoogleCharts       *//* boolean,  disable google charts
 *                                                  (default: false) */
/*global hibenchmarksNoMorris             *//* boolean,  disable morris charts
 *                                                  (default: false) */
/*global hibenchmarksNoEasyPieChart       *//* boolean,  disable easypiechart charts
 *                                                  (default: false) */
/*global hibenchmarksNoGauge              *//* boolean,  disable gauge.js charts
 *                                                  (default: false) */
/*global hibenchmarksNoD3                 *//* boolean,  disable d3 charts
 *                                                  (default: false) */
/*global hibenchmarksNoC3                 *//* boolean,  disable c3 charts
 *                                                  (default: false) */
/*global hibenchmarksNoD3pie              *//* boolean,  disable d3pie charts
 *                                                  (default: false) */
/*global hibenchmarksNoBootstrap          *//* boolean,  disable bootstrap - disables help too
 *                                                  (default: false) */
/*global hibenchmarksNoFontAwesome        *//* boolean,  disable fontawesome (do not load it)
 *                                                  (default: false) */
/*global hibenchmarksIcons                *//* object,   overwrite hibenchmarks fontawesome icons
 *                                                  (default: null) */
/*global hibenchmarksDontStart            *//* boolean,  do not start the thread to process the charts
 *                                                  (default: false) */
/*global hibenchmarksErrorCallback        *//* function, callback to be called when the dashboard encounters an error
 *                                                  (default: null) */
/*global hibenchmarksRegistry:true        *//* boolean,  use the hibenchmarks registry
 *                                                  (default: false) */
/*global hibenchmarksNoRegistry           *//* boolean,  included only for compatibility with existing custom dashboard
 *                                                  (obsolete - do not use this any more) */
/*global hibenchmarksRegistryCallback     *//* function, callback that will be invoked with one param: the URLs from the registry
 *                                                  (default: null) */
/*global hibenchmarksShowHelp:true        *//* boolean,  disable charts help
 *                                                  (default: true) */
/*global hibenchmarksShowAlarms:true      *//* boolean,  enable alarms checks and notifications
 *                                                  (default: false) */
/*global hibenchmarksRegistryAfterMs:true *//* ms,       delay registry use at started
 *                                                  (default: 1500) */
/*global hibenchmarksCallback             *//* function, callback to be called when hibenchmarks is ready to start
 *                                                  (default: null)
 *                                                  hibenchmarks will be running while this is called
 *                                                  (call HIBENCHMARKS.pause to stop it) */
/*global hibenchmarksPrepCallback         *//* function, callback to be called before hibenchmarks does anything else
 *                                                  (default: null) */
/*global hibenchmarksServer               *//* string,   the URL of the hibenchmarks server to use
 *                                                  (default: the URL the page is hosted at) */
/*global hibenchmarksServerStatic         *//* string,   the URL of the hibenchmarks server to use for static files
 *                                                  (default: hibenchmarksServer) */
/*global hibenchmarksSnapshotData         *//* object,   a hibenchmarks snapshot loaded
 *                                                  (default: null) */
/*global hibenchmarksAlarmsRecipients     *//* array,    an array of alarm recipients to show notifications for
 *                                                  (default: null) */
/*global hibenchmarksAlarmsRemember       *//* boolen,   keep our position in the alarm log at browser local storage
 *                                                  (default: true) */
/*global hibenchmarksAlarmsActiveCallback *//* function, a hook for the alarm logs
 *                                                  (default: undefined) */
/*global hibenchmarksAlarmsNotifCallback  *//* function, a hook for alarm notifications
 *                                                  (default: undefined) */
/*global hibenchmarksIntersectionObserver *//* boolean,  enable or disable the use of intersection observer
 *                                                  (default: true) */
/*global hibenchmarksCheckXSS             *//* boolean,  enable or disable checking for XSS issues
 *                                                  (default: false) */

// ----------------------------------------------------------------------------
// global namespace

var HIBENCHMARKS = window.HIBENCHMARKS || {};
...
(function(window, document, $, undefined) {
    ...
    HIBENCHMARKS.name2id = function(s) {
        return s
            .replace(/ /g, '_')
            .replace(/\(/g, '_')
            .replace(/\)/g, '_')
    ...
    HIBENCHMARKS.xss = {
        enabled: (typeof hibenchmarksCheckXSS === 'undefined')?false:hibenchmarksCheckXSS,
        enabled_for_data: (typeof hibenchmarksCheckXSS === 'undefined')?false:hibenchmarksCheckXSS,
    ...
    // ----------------------------------------------------------------------------------------------------------------
    // Detect the hibenchmarks server

    // http://stackoverflow.com/questions/984510/what-is-my-script-src-url
    // http://stackoverflow.com/questions/6941533/get-protocol-domain-and-port-from-url
    HIBENCHMARKS._scriptSource = function() {
        var script = null;
    ...
    if(typeof hibenchmarksServer !== 'undefined')
        HIBENCHMARKS.serverDefault = hibenchmarksServer;
    else {
        var s = HIBENCHMARKS._scriptSource();
        if(s) HIBENCHMARKS.serverDefault = s.replace(/\/dashboard.js(\?.*)*$/g, "");
        else {
            console.log('WARNING: Cannot detect the URL of the hibenchmarks server.');
            HIBENCHMARKS.serverDefault = null;
        }
    }

    if(HIBENCHMARKS.serverDefault === null)
        HIBENCHMARKS.serverDefault = '';
    else if(HIBENCHMARKS.serverDefault.slice(-1) !== '/')
        HIBENCHMARKS.serverDefault += '/';

    if(typeof hibenchmarksServerStatic !== 'undefined' && hibenchmarksServerStatic !== null && hibenchmarksServerStatic !== '') {
        HIBENCHMARKS.serverStatic = hibenchmarksServerStatic;
        if(HIBENCHMARKS.serverStatic.slice(-1) !== '/')
            HIBENCHMARKS.serverStatic += '/';
    }
    else {
        HIBENCHMARKS.serverStatic = HIBENCHMARKS.serverDefault;
    }
    ...
    HIBENCHMARKS.jQuery              = HIBENCHMARKS.serverStatic + 'lib/jquery-2.2.4.min.js';
    HIBENCHMARKS.peity_js            = HIBENCHMARKS.serverStatic + 'lib/jquery.peity-3.2.0.min.js';
    HIBENCHMARKS.sparkline_js        = HIBENCHMARKS.serverStatic + 'lib/jquery.sparkline-2.1.2.min.js';
    HIBENCHMARKS.easypiechart_js     = HIBENCHMARKS.serverStatic + 'lib/jquery.easypiechart-97b5824.min.js';
    HIBENCHMARKS.gauge_js            = HIBENCHMARKS.serverStatic + 'lib/gauge-1.3.2.min.js';
    HIBENCHMARKS.dygraph_js          = HIBENCHMARKS.serverStatic + 'lib/dygraph-c91c859.min.js';
    HIBENCHMARKS.dygraph_smooth_js   = HIBENCHMARKS.serverStatic + 'lib/dygraph-smooth-plotter-c91c859.js';
    HIBENCHMARKS.raphael_js          = HIBENCHMARKS.serverStatic + 'lib/raphael-2.2.4-min.js';
    HIBENCHMARKS.c3_js               = HIBENCHMARKS.serverStatic + 'lib/c3-0.4.18.min.js';
    HIBENCHMARKS.c3_css              = HIBENCHMARKS.serverStatic + 'css/c3-0.4.18.min.css';
    HIBENCHMARKS.d3pie_js            = HIBENCHMARKS.serverStatic + 'lib/d3pie-0.2.1-hibenchmarks-3.js';
    HIBENCHMARKS.d3_js               = HIBENCHMARKS.serverStatic + 'lib/d3-4.12.2.min.js';
    HIBENCHMARKS.morris_js           = HIBENCHMARKS.serverStatic + 'lib/morris-0.5.1.min.js';
    HIBENCHMARKS.morris_css          = HIBENCHMARKS.serverStatic + 'css/morris-0.5.1.css';
    HIBENCHMARKS.google_js           = 'https://www.google.com/jsapi';

    HIBENCHMARKS.themes = {
        white: {
            bootstrap_css: HIBENCHMARKS.serverStatic + 'css/bootstrap-3.3.7.css',
            dashboard_css: HIBENCHMARKS.serverStatic + 'dashboard.css?v20180210-1',
            background: '#FFFFFF',
            foreground: '#000000',
            grid: '#F0F0F0',
            axis: '#F0F0F0',
        ...
        slate: {
            bootstrap_css: HIBENCHMARKS.serverStatic + 'css/bootstrap-slate-flat-3.3.7.css?v20161229-1',
            dashboard_css: HIBENCHMARKS.serverStatic + 'dashboard.slate.css?v20180210-1',
            background: '#272b30',
            foreground: '#C8C8C8',
            grid: '#283236',
            axis: '#283236',
...
*/
    ...
    if(typeof hibenchmarksTheme !== 'undefined' && typeof HIBENCHMARKS.themes[hibenchmarksTheme] !== 'undefined')
        HIBENCHMARKS.themes.current = HIBENCHMARKS.themes[hibenchmarksTheme];
    else
        HIBENCHMARKS.themes.current = HIBENCHMARKS.themes.white;

    HIBENCHMARKS.colors = HIBENCHMARKS.themes.current.colors;
    ...
    //HIBENCHMARKS.colors        = [ '#3366CC', '#DC3912', '#FF9900', '#109618', '#990099', '#3B3EAC', '#0099C6',
    ...
    //HIBENCHMARKS.colors        = [ '#5DA5DA', '#F15854', '#FAA43A', '#60BD68', '#F17CB0', '#B2912F', '#B276B2', '#DECF3F', '#4D4D4D' ];
    ...
    if(typeof hibenchmarksIcons === 'object') {
        for(var icon in HIBENCHMARKS.icons) {
            if(HIBENCHMARKS.icons.hasOwnProperty(icon) && typeof(hibenchmarksIcons[icon]) === 'string')
                HIBENCHMARKS.icons[icon] = hibenchmarksIcons[icon];
        }
    }

    if(typeof hibenchmarksSnapshotData === 'undefined')
        hibenchmarksSnapshotData = null;

    if(typeof hibenchmarksShowHelp === 'undefined')
        hibenchmarksShowHelp = true;

    if(typeof hibenchmarksShowAlarms === 'undefined')
        hibenchmarksShowAlarms = false;

    if(typeof hibenchmarksRegistryAfterMs !== 'number' || hibenchmarksRegistryAfterMs < 0)
        hibenchmarksRegistryAfterMs = 1500;

    if(typeof hibenchmarksRegistry === 'undefined') {
        // backward compatibility
        hibenchmarksRegistry = (typeof hibenchmarksNoRegistry !== 'undefined' && hibenchmarksNoRegistry === false);
    }
    if(hibenchmarksRegistry === false && typeof hibenchmarksRegistryCallback === 'function')
        hibenchmarksRegistry = true;
    ...
    HIBENCHMARKS.options = {
        ...
        current: {
            ...
            show_help: hibenchmarksShowHelp, // when enabled the charts will show some help
    ...
    HIBENCHMARKS.timeout.init();


    // ----------------------------------------------------------------------------------------------------------------
    // local storage options

    HIBENCHMARKS.localStorage = {
        default: {},
        current: {},
        callback: {} // only used for resetting back to defaults
    };

    HIBENCHMARKS.localStorageTested = -1;
    HIBENCHMARKS.localStorageTest = function() {
        if(HIBENCHMARKS.localStorageTested !== -1)
            return HIBENCHMARKS.localStorageTested;
        ...
        if(typeof Storage !== "undefined" && typeof localStorage === 'object') {
            ...
            try {
                ...
                HIBENCHMARKS.localStorageTested = true;
            }
            catch (e) {
                HIBENCHMARKS.localStorageTested = false;
            }
        }
        else
            HIBENCHMARKS.localStorageTested = false;
    ...
    HIBENCHMARKS.localStorageGet = function(key, def, callback) {
        var ret = def;

        if(typeof HIBENCHMARKS.localStorage.default[key.toString()] === 'undefined') {
            HIBENCHMARKS.localStorage.default[key.toString()] = def;
            HIBENCHMARKS.localStorage.callback[key.toString()] = callback;
        }

        if(HIBENCHMARKS.localStorageTest() === true) {
            try {
                // console.log('localStorage: loading "' + key.toString() + '"');
                ret = localStorage.getItem(key.toString());
                // console.log('hibenchmarks loaded: ' + key.toString() + ' = ' + ret.toString());
        ...
        HIBENCHMARKS.localStorage.current[key.toString()] = ret;
        return ret;
    };

    HIBENCHMARKS.localStorageSet = function(key, value, callback) {
        if(typeof value === 'undefined' || value === 'undefined') {
            console.log('localStorage: ATTEMPT TO SET UNDEFINED "' + key.toString() + '" as value ' + value + ' of type ' + typeof(value));
        }

        if(typeof HIBENCHMARKS.localStorage.default[key.toString()] === 'undefined') {
            HIBENCHMARKS.localStorage.default[key.toString()] = value;
            HIBENCHMARKS.localStorage.current[key.toString()] = value;
            HIBENCHMARKS.localStorage.callback[key.toString()] = callback;
        }
    ...
    HIBENCHMARKS.localStorageGetRecursive = function(obj, prefix, callback) {
        ...
        while(len--) {
            ...
            if(typeof obj[i] === 'object') {
                ...
                HIBENCHMARKS.localStorageGetRecursive(obj[i], prefix + '.' + i.toString(), callback);
                continue;
            }

            obj[i] = HIBENCHMARKS.localStorageGet(prefix + '.' + i.toString(), obj[i], callback);
        }
    };

    HIBENCHMARKS.setOption = function(key, value) {
        if(key.toString() === 'setOptionCallback') {
            if(typeof HIBENCHMARKS.options.current.setOptionCallback === 'function') {
                HIBENCHMARKS.options.current[key.toString()] = value;
                HIBENCHMARKS.options.current.setOptionCallback();
            }
        }
        else if(HIBENCHMARKS.options.current[key.toString()] !== value) {
            var name = 'options.' + key.toString();

            if(typeof HIBENCHMARKS.localStorage.default[name.toString()] === 'undefined')
                console.log('localStorage: setOption() on unsaved option: "' + name.toString() + '", value: ' + value);

            //console.log(HIBENCHMARKS.localStorage);
            //console.log('setOption: setting "' + key.toString() + '" to "' + value + '" of type ' + typeof(value) + ' original type ' + typeof(HIBENCHMARKS.options.current[key.toString()]));
            //console.log(HIBENCHMARKS.options);
            HIBENCHMARKS.options.current[key.toString()] = HIBENCHMARKS.localStorageSet(name.toString(), value, null);
    ...
    HIBENCHMARKS.getOption = function(key) {
        return HIBENCHMARKS.options.current[key.toString()];
    };

    // read settings from local storage
    HIBENCHMARKS.localStorageGetRecursive(HIBENCHMARKS.options.current, 'options', null);

    // always start with this option enabled.
    HIBENCHMARKS.setOption('stop_updates_when_focus_is_lost', true);

    HIBENCHMARKS.resetOptions = function() {
        var keys = Object.keys(HIBENCHMARKS.localStorage.default);
        var len = keys.length;
        while(len--) {
            var i = keys[len];
            var a = i.split('.');
            ...
            if(a[0] === 'options') {
                ...
                if(typeof HIBENCHMARKS.localStorage.default[i] === 'undefined') continue;
                if(HIBENCHMARKS.options.current[i] === HIBENCHMARKS.localStorage.default[i]) continue;

                HIBENCHMARKS.setOption(a[1], HIBENCHMARKS.localStorage.default[i]);
            }
            else if(a[0] === 'chart_heights') {
                if(typeof HIBENCHMARKS.localStorage.callback[i] === 'function' && typeof HIBENCHMARKS.localStorage.default[i] !== 'undefined') {
                    HIBENCHMARKS.localStorage.callback[i](HIBENCHMARKS.localStorage.default[i]);
                }
            }
        }

        HIBENCHMARKS.dateTime.init(HIBENCHMARKS.options.current.timezone);
    };

    // ----------------------------------------------------------------------------------------------------------------

    if(HIBENCHMARKS.options.debug.main_loop === true)
        console.log('welcome to HIBENCHMARKS');

    HIBENCHMARKS.onresizeCallback = null;
    HIBENCHMARKS.onresize = function() {
        HIBENCHMARKS.options.last_page_resize = Date.now();
        HIBENCHMARKS.onscroll();

        if(typeof HIBENCHMARKS.onresizeCallback === 'function')
            HIBENCHMARKS.onresizeCallback();
    };

    HIBENCHMARKS.abort_all_refreshes = function() {
        var targets = HIBENCHMARKS.options.targets;
    ...
    HIBENCHMARKS.onscroll_start_delay = function() {
        HIBENCHMARKS.options.last_page_scroll = Date.now();

        HIBENCHMARKS.options.on_scroll_refresher_stop_until =
            HIBENCHMARKS.options.last_page_scroll
            + ((HIBENCHMARKS.options.current.async_on_scroll === true) ? 1000 : 0);
    };

    HIBENCHMARKS.onscroll_end_delay = function() {
        HIBENCHMARKS.options.on_scroll_refresher_stop_until =
            Date.now()
            + ((HIBENCHMARKS.options.current.async_on_scroll === true) ? HIBENCHMARKS.options.current.onscroll_worker_duration_threshold : 0);
    };

    HIBENCHMARKS.onscroll_updater_timeout_id = undefined;
    HIBENCHMARKS.onscroll_updater = function() {
        HIBENCHMARKS.globalSelectionSync.stop();

        if(HIBENCHMARKS.options.abort_ajax_on_scroll === true)
            HIBENCHMARKS.abort_all_refreshes();
        ...
        if(HIBENCHMARKS.intersectionObserver.enabled() === false) {
            if (HIBENCHMARKS.options.current.parallel_refresher === false) {
                var targets = HIBENCHMARKS.options.targets;
                var len = targets.length;
        ...
        HIBENCHMARKS.onscroll_end_delay();
    };

    HIBENCHMARKS.scrollUp = false;
    HIBENCHMARKS.scrollY = window.scrollY;
    HIBENCHMARKS.onscroll = function() {
        //console.log('onscroll() begin');

        HIBENCHMARKS.onscroll_start_delay();
        HIBENCHMARKS.chartRefresherReschedule();

        HIBENCHMARKS.scrollUp = (window.scrollY > HIBENCHMARKS.scrollY);
        HIBENCHMARKS.scrollY = window.scrollY;

        if(HIBENCHMARKS.onscroll_updater_timeout_id)
            HIBENCHMARKS.timeout.clear(HIBENCHMARKS.onscroll_updater_timeout_id);

        HIBENCHMARKS.onscroll_updater_timeout_id = HIBENCHMARKS.timeout.set(HIBENCHMARKS.onscroll_updater, 0);
        //console.log('onscroll() end');
    };

    HIBENCHMARKS.supportsPassiveEvents = function() {
        if(HIBENCHMARKS.options.passive_events === null) {
            ...
            HIBENCHMARKS.options.passive_events = supportsPassive;
        }

        // console.log('passive ' + HIBENCHMARKS.options.passive_events);
        return HIBENCHMARKS.options.passive_events;
    };

    window.addEventListener('resize', HIBENCHMARKS.onresize, HIBENCHMARKS.supportsPassiveEvents() ? { passive: true } : false);
    window.addEventListener('scroll', HIBENCHMARKS.onscroll, HIBENCHMARKS.supportsPassiveEvents() ? { passive: true } : false);
    // window.onresize = HIBENCHMARKS.onresize;
    // window.onscroll = HIBENCHMARKS.onscroll;

    // ----------------------------------------------------------------------------------------------------------------
    // Error Handling

    HIBENCHMARKS.errorCodes = {
    ...
    HIBENCHMARKS.error = function(code, msg) {
        HIBENCHMARKS.errorLast.code = code;
        HIBENCHMARKS.errorLast.message = msg;
        HIBENCHMARKS.errorLast.datetime = Date.now();

        console.log("ERROR " + code + ": " + HIBENCHMARKS.errorCodes[code].message + ": " + msg);

        var ret = true;
        if(typeof hibenchmarksErrorCallback === 'function') {
           ret = hibenchmarksErrorCallback('system', code, msg);
        }

        if(ret && HIBENCHMARKS.errorCodes[code].alert)
            alert("ERROR " + code + ": " + HIBENCHMARKS.errorCodes[code].message + ": " + msg);
    };

    HIBENCHMARKS.errorReset = function() {
        HIBENCHMARKS.errorLast.code = 0;
        HIBENCHMARKS.errorLast.message = "You are doing fine!";
        HIBENCHMARKS.errorLast.datetime = 0;
    };

    // ----------------------------------------------------------------------------------------------------------------
    // fast numbers formatting

    HIBENCHMARKS.fastNumberFormat = {
        formatters_fixed: [],
    ...
    HIBENCHMARKS.dataAttribute = function(element, attribute, def) {
    ...
    HIBENCHMARKS.dataAttributeBoolean = function(element, attribute, def) {
        var value = HIBENCHMARKS.dataAttribute(element, attribute, def);
    ...
    HIBENCHMARKS.commonMin = {
        ...
        get: function(state) {
            if(typeof state.tmp.__commonMin === 'undefined') {
                ...
                state.tmp.__commonMin = HIBENCHMARKS.dataAttribute(state.element, 'common-min', null);
            }
    ...
    HIBENCHMARKS.commonMax = {
        ...
        get: function(state) {
            if(typeof state.tmp.__commonMax === 'undefined') {
                ...
                state.tmp.__commonMax = HIBENCHMARKS.dataAttribute(state.element, 'common-max', null);
            }
    ...
    HIBENCHMARKS.commonColors = {
        ...
        refill: function(state) {
            ...
            if(ret.available.length === 0) {
                if(ret.copy_theme === true || ret.custom.length === 0) {
                    ...
                    len = HIBENCHMARKS.themes.current.colors.length;
                    while (len--)
                        ret.available.unshift(HIBENCHMARKS.themes.current.colors[len]);
                }
        ...
        __read_custom_colors: function(state, ret) {
            ...
            var c = HIBENCHMARKS.dataAttribute(state.element, 'colors', undefined);
        ...
        prepare: function(state) {
            ...
            if(typeof state.tmp.__commonColors === 'undefined') {
                ...
                state.tmp.__commonColors = HIBENCHMARKS.dataAttribute(state.element, 'common-colors', defname);
            }
    ...
    HIBENCHMARKS.fixHost = function(host) {
        while(host.slice(-1) === '/')
    ...
    HIBENCHMARKS.chartRegistry = {
        ...
        downloadAll: function(host, callback) {
            host = HIBENCHMARKS.fixHost(host);
            ...
            function got_data(h, data, callback) {
                if(data !== null) {
                    ...
                    if(typeof data.timezone === 'string')
                        HIBENCHMARKS.options.server_timezone = data.timezone;
                }
                else HIBENCHMARKS.error(406, h + '/api/v1/charts');

                if(typeof callback === 'function')
                    callback(data);
            }

            if(hibenchmarksSnapshotData !== null) {
                got_data(host, hibenchmarksSnapshotData.charts, callback);
            }
            else {
                $.ajax({
                    ...
                    .done(function (data) {
                        data = HIBENCHMARKS.xss.checkOptional('/api/v1/charts', data);
                        got_data(host, data, callback);
                    })
                    .fail(function () {
                        HIBENCHMARKS.error(405, host + '/api/v1/charts');
    ...
    HIBENCHMARKS.globalPanAndZoom = {
        ...
        delay: function() {
            if(HIBENCHMARKS.options.debug.globalPanAndZoom === true)
                console.log('globalPanAndZoom.delay()');

            HIBENCHMARKS.options.auto_refresher_stop_until = Date.now() + HIBENCHMARKS.options.current.global_pan_sync_time;
        },
        ...
        setMaster: function(state, after, before) {
            ...
            if(HIBENCHMARKS.options.current.sync_pan_and_zoom === false)
                return;
        ...
        clearMaster: function() {
            ...
            this.force_after_ms = null;
            this.force_before_ms = null;
            HIBENCHMARKS.options.auto_refresher_stop_until = 0;
    ...
    HIBENCHMARKS.globalChartUnderlay = {
        ...
        setup: function() {
            if(this.isActive() === true) {
                if (this.state === null)
                    this.state = HIBENCHMARKS.options.targets[0];
        ...
        set: function(state, after, before, view_after, view_before) {
            ...
            if (this.hasViewport() === true)
                HIBENCHMARKS.globalPanAndZoom.setMaster(this.state, this.view_after, this.view_before);
        ...
        focus: function() {
            if(this.isActive() === true && this.hasViewport() === true) {
                ...
                if(HIBENCHMARKS.globalPanAndZoom.isMaster(this.state) === true)
                    HIBENCHMARKS.globalPanAndZoom.clearMaster();

                HIBENCHMARKS.globalPanAndZoom.setMaster(this.state, this.view_after, this.view_before, true);
            }
        }
    };
    ...
    var dimensionStatus = function(parent, label, name_div, value_div, color) {
        ...
        this.name_div = null;
        this.value_div = null;
        this.color = HIBENCHMARKS.themes.current.foreground;
    ...
    dimensionStatus.prototype.setOptions = function(name_div, value_div, color) {
        ...
        if(this.name_div !== name_div) {
            ...
            if(this.selected === false)
                this.name_div.className = 'hibenchmarks-legend-name not-selected';
            else
                this.name_div.className = 'hibenchmarks-legend-name selected';
        }
        ...
        if(this.value_div !== value_div) {
            ...
            if(this.selected === false)
                this.value_div.className = 'hibenchmarks-legend-value not-selected';
            else
                this.value_div.className = 'hibenchmarks-legend-value selected';
        }
    ...
    dimensionStatus.prototype.unselect = function() {
        ...
        this.name_div.className = 'hibenchmarks-legend-name not-selected';
        this.value_div.className = 'hibenchmarks-legend-value hidden';
        this.selected = false;
    };
    ...
    HIBENCHMARKS.dateTime = {
        using_timezone: false,

        // these are the old hibenchmarks functions
        ...
        xAxisTimeStringNative: function(d) {
            return HIBENCHMARKS.zeropad(d.getHours())  + ":"
                + HIBENCHMARKS.zeropad(d.getMinutes()) + ":"
                + HIBENCHMARKS.zeropad(d.getSeconds());
        },
        ...
        init: function(timezone) {
            ...
            try {
                HIBENCHMARKS.options.browser_timezone = Intl.DateTimeFormat().resolvedOptions().timeZone;
            }
            catch(e) {
                console.log('failed to detect browser timezone: ' + e.toString());
                HIBENCHMARKS.options.browser_timezone = 'cannot-detect-it';
            }
            ...
            HIBENCHMARKS.setOption('timezone', timezone);
    ...
    HIBENCHMARKS.unitsConversion = {
        ...
        convertibleUnits: {
            'Celsius': {
                'Fahrenheit': {
                    check: function(max) { void(max); return HIBENCHMARKS.options.current.temperature === 'fahrenheit'; },
            ...
            'seconds': {
                'time': {
                    check: function (max) { void(max); return HIBENCHMARKS.options.current.seconds_as_time; },
                    convert: function(seconds) { return HIBENCHMARKS.unitsConversion.seconds2time(seconds); }
                }
            },
            'milliseconds': {
                'milliseconds': {
                    check: function (max) { return HIBENCHMARKS.options.current.seconds_as_time && max < 1000; },
                ...
                'seconds': {
                    check: function (max) { return HIBENCHMARKS.options.current.seconds_as_time && max >= 1000 && max < 60000; },
                    convert: function(milliseconds) {
                        ...
                        return seconds.toString() + '.'
                            + HIBENCHMARKS.zeropad(milliseconds);
                    }
                },
                'M:SS.ms': {
                    check: function (max) { return HIBENCHMARKS.options.current.seconds_as_time && max >= 60000; },
                    convert: function(milliseconds) {
                        milliseconds = Math.round(milliseconds);
        ...
        seconds2time: function(seconds) {
            ...
            */
            ...
            return ((days > 0)?days.toString() + 'd:':'').toString()
                + HIBENCHMARKS.zeropad(hours) + ':'
                + HIBENCHMARKS.zeropad(minutes) + ':'
                + HIBENCHMARKS.zeropad(seconds)
                + ms_txt;
        },
        ...
        get: function(uuid, min, max, units, desired_units, common_units_name, switch_units_callback) {
            ...
            if(typeof this.scalableUnits[units] !== 'undefined') {
                ...
                // console.log('HIBENCHMARKS.unitsConversion.get(' + units.toString() + ', ' + desired_units.toString() + ', function()) decide divider with min = ' + min.toString() + ', max = ' + max.toString());
    ...
    HIBENCHMARKS.globalSelectionSync = {
        state: null,
        dont_sync_before: 0,
        last_t: 0,
        slaves: [],
        ...
        enabled: function() {
            ...
            if(HIBENCHMARKS.options.current.sync_selection === false)
                return false;
        ...
        setMaster: function(state) {
            ...
            if(HIBENCHMARKS.options.debug.globalSelectionSync === true)
            ...
            // find all slaves
            var targets = HIBENCHMARKS.intersectionObserver.targets();
            this.slaves = [];
            var len = targets.length;
            while(len--) {
                var st = targets[len];
        ...
        delay: function(ms) {
            if(HIBENCHMARKS.options.current.sync_selection === true) {
                if(HIBENCHMARKS.options.debug.globalSelectionSync === true)
                ...
                if(typeof ms === 'number')
                    ...
                    this.dont_sync_before = Date.now() + HIBENCHMARKS.options.current.sync_selection_delay;
            }
        },

        __syncSlaves: function() {
            if(HIBENCHMARKS.globalSelectionSync.enabled() === true) {
                if(HIBENCHMARKS.options.debug.globalSelectionSync === true)
                    console.log('globalSelectionSync.__syncSlaves()');

                var t = HIBENCHMARKS.globalSelectionSync.last_t;
                var len = HIBENCHMARKS.globalSelectionSync.slaves.length;
                while (len--)
                    HIBENCHMARKS.globalSelectionSync.slaves[len].setSelection(t);
        ...
        sync: function(state, t) {
            if(HIBENCHMARKS.options.current.sync_selection === true) {
                ...
                if (state.foreign_element_selection !== null)
                    state.foreign_element_selection.innerText = HIBENCHMARKS.dateTime.localeDateString(t) + ' ' + HIBENCHMARKS.dateTime.localeTimeString(t);

                if (this.timeout_id)
                    HIBENCHMARKS.timeout.clear(this.timeout_id);

                this.timeout_id = HIBENCHMARKS.timeout.set(this.__syncSlaves, 0);
            }
        }
    };

    HIBENCHMARKS.intersectionObserver = {
        observer: null,
        visible_targets: [],
        ...
        targets: function() {
            if(this.enabled() === true && this.visible_targets.length > 0)
                ...
                return HIBENCHMARKS.options.targets;
        },
        ...
        handler: function(entries, observer) {
            entries.forEach(function(entry) {
                var state = HIBENCHMARKS.chartState(entry.target);

                var idx;
                if(entry.intersectionRatio > 0) {
                    idx = HIBENCHMARKS.intersectionObserver.visible_targets.indexOf(state);
                    if(idx === -1) {
                        if(HIBENCHMARKS.scrollUp === true)
                            HIBENCHMARKS.intersectionObserver.visible_targets.push(state);
                        else
                            HIBENCHMARKS.intersectionObserver.visible_targets.unshift(state);
                    }
                    ...
                    idx = HIBENCHMARKS.intersectionObserver.visible_targets.indexOf(state);
                    if(idx !== -1)
                        HIBENCHMARKS.intersectionObserver.visible_targets.splice(idx, 1);
                    else if(state.__visibilityRatio > 0)
                ...
                if(HIBENCHMARKS.options.current.async_on_scroll === false) {
                    if(window.requestIdleCallback)
                        window.requestIdleCallback(function() {
                            HIBENCHMARKS.intersectionObserver.switchChartVisibility.call(state);
                        }, {timeout: 100});
                    else
                        HIBENCHMARKS.intersectionObserver.switchChartVisibility.call(state);
                }
        ...
        observe: function(state) {
            if(this.enabled() === true) {
                ...
                state.isVisible = function() {
                    if(HIBENCHMARKS.options.current.update_only_visible === false)
                        return true;

                    HIBENCHMARKS.intersectionObserver.switchChartVisibility.call(this);
        ...
        init: function() {
            if(typeof hibenchmarksIntersectionObserver === 'undefined' || hibenchmarksIntersectionObserver === true) {
                try {
    ...
    HIBENCHMARKS.intersectionObserver.init();
    ...
    var chartState = function(element) {
        ...
        var error = function(msg) {
            ...
            if(typeof hibenchmarksErrorCallback === 'function') {
                ret = hibenchmarksErrorCallback('chart', that.id, msg);
            }
        ...
        this.uuid = HIBENCHMARKS.guid();

        // string - the name of chart
        this.id = HIBENCHMARKS.dataAttribute(this.element, 'hibenchmarks', undefined);
        if(typeof this.id === 'undefined') {
            error("hibenchmarks elements need data-hibenchmarks");
            return;
        }

        // string - the key for localStorage settings
        this.settings_id = HIBENCHMARKS.dataAttribute(this.element, 'id', null);

        // the user given dimensions of the element
        this.width = HIBENCHMARKS.dataAttribute(this.element, 'width', HIBENCHMARKS.chartDefaults.width);
        this.height = HIBENCHMARKS.dataAttribute(this.element, 'height', HIBENCHMARKS.chartDefaults.height);
        this.height_original = this.height;

        if(this.settings_id !== null) {
            this.height = HIBENCHMARKS.localStorageGet('chart_heights.' + this.settings_id, this.height, function(height) {
        ...
        this.library_name = HIBENCHMARKS.dataAttribute(this.element, 'chart-library', HIBENCHMARKS.chartDefaults.library);
        ...
        if(typeof HIBENCHMARKS.chartLibraries[this.library_name] === 'undefined') {
            HIBENCHMARKS.error(402, this.library_name);
            error('chart library "' + this.library_name + '" is not found');
            this.enabled = false;
        }
        else if(HIBENCHMARKS.chartLibraries[this.library_name].enabled === false) {
            HIBENCHMARKS.error(403, this.library_name);
            error('chart library "' + this.library_name + '" is not enabled');
            this.enabled = false;
        }
        else
            this.library = HIBENCHMARKS.chartLibraries[this.library_name];
        ...
        var runtimeInit = function() {
            ...
            that.tm = {
                ...
                pan_and_zoom_seq: 0,                    // the sequence number of the global synchronization
                                                        // between chart.
                                                        // Used with HIBENCHMARKS.globalPanAndZoom.seq
            ...
            that.data = null;                           // the last data as downloaded from the hibenchmarks server
            that.data_url = 'invalid://';               // string - the last url used to update the chart
            that.data_points = 0;                       // number - the number of points returned from hibenchmarks
        ...
        var lateInitialization = function() {
            ...
            // string - the hibenchmarks server URL, without any path
            that.host = HIBENCHMARKS.dataAttribute(that.element, 'host', HIBENCHMARKS.serverDefault);

            // make sure the host does not end with /
            // all hibenchmarks API requests use absolute paths
            ...
            that.method = HIBENCHMARKS.dataAttribute(that.element, 'method', HIBENCHMARKS.chartDefaults.method);
            that.gtime = HIBENCHMARKS.dataAttribute(that.element, 'gtime', 0);

            // the time-range requested by the user
            that.after = HIBENCHMARKS.dataAttribute(that.element, 'after', HIBENCHMARKS.chartDefaults.after);
            that.before = HIBENCHMARKS.dataAttribute(that.element, 'before', HIBENCHMARKS.chartDefaults.before);

            // the pixels per point requested by the user
            that.pixels_per_point = HIBENCHMARKS.dataAttribute(that.element, 'pixels-per-point', 1);
            that.points = HIBENCHMARKS.dataAttribute(that.element, 'points', null);

            // the forced update_every
            that.force_update_every = HIBENCHMARKS.dataAttribute(that.element, 'update-every', null);
            ...
            that.dimensions = HIBENCHMARKS.dataAttribute(that.element, 'dimensions', null);

            that.title = HIBENCHMARKS.dataAttribute(that.element, 'title', null);    // the title of the chart
            that.units = HIBENCHMARKS.dataAttribute(that.element, 'units', null);    // the units of the chart dimensions
            that.units_desired = HIBENCHMARKS.dataAttribute(that.element, 'desired-units', HIBENCHMARKS.options.current.units); // the units of the chart dimensions
            that.units_current = that.units;
            that.units_common = HIBENCHMARKS.dataAttribute(that.element, 'common-units', null);

            that.append_options = HIBENCHMARKS.dataAttribute(that.element, 'append-options', null); // additional options to pass to hibenchmarks
            that.override_options = HIBENCHMARKS.dataAttribute(that.element, 'override-options', null);  // override options to pass to hibenchmarks

            that.debug = HIBENCHMARKS.dataAttributeBoolean(that.element, 'debug', false);

            that.value_decimal_detail = -1;
            var d = HIBENCHMARKS.dataAttribute(that.element, 'decimal-digits', -1);
            if(typeof d === 'number')
            ...
            var refresh_dt_element_name = HIBENCHMARKS.dataAttribute(that.element, 'dt-element-name', null); // string - the element to print refresh_dt_ms
            ...
            that.hibenchmarks_first = 0;                     // milliseconds - the first timestamp in hibenchmarks
            that.hibenchmarks_last = 0;                      // milliseconds - the last timestamp in hibenchmarks
            ...
            function get_foreign_element_by_id(opt) {
                var id = HIBENCHMARKS.dataAttribute(that.element, opt, null);
                if(id === null) {
        ...
        var destroyDOM = function() {
            ...
            // that.element.className = 'hibenchmarks-message icon';
            // that.element.innerHTML = '<i class="fas fa-sync"></i> hibenchmarks';
        ...
        var createDOM = function() {
            ...
            that.element_message.className = 'hibenchmarks-message icon hidden';
        ...
        var initDOM = function() {
            ...
            if(HIBENCHMARKS.chartDefaults.min_width !== null)
                that.element.style.min_width = HIBENCHMARKS.chartDefaults.min_width;
        };
        ...
        var showRendering = function() {
            ...
            if(that.chart !== null) {
                if(that.chart.chart_type === 'line')
                    icon = HIBENCHMARKS.icons.lineChart;
                else
                    icon = HIBENCHMARKS.icons.areaChart;
            }
            else
                icon = HIBENCHMARKS.icons.noChart;

            showMessageIcon(icon + ' hibenchmarks' + invisibleSearchableText());
        };

        var showLoading = function() {
            if(that.chart_created === false) {
                showMessageIcon(HIBENCHMARKS.icons.loading + ' hibenchmarks');
                return true;
            }
            return false;
        };
        ...
        this.hideChart = function() {
            ...
            if(this.chart_created === true) {
                if(HIBENCHMARKS.options.current.show_help === true) {
                ...
                if(HIBENCHMARKS.options.current.destroy_on_hide === true) {
                    if(this.debug === true)
        ...
        var canBeRendered = function(uncached_visibility) {
            ...
            var ret = (
                (
                    HIBENCHMARKS.options.page_is_visible === true ||
                    HIBENCHMARKS.options.current.stop_updates_when_focus_is_lost === false ||
        ...
        var callChartLibraryUpdateSafely = function(data) {
            ...
            if(HIBENCHMARKS.options.fake_chart_rendering === true)
                return true;
            ...
            if(HIBENCHMARKS.options.debug.chart_errors === true)
        ...
        var resizeChart = function() {
            if(that.tm.last_resized < HIBENCHMARKS.options.last_page_resize) {
        ...
        var resizeChartToHeight = function(h) {
            ...
            if(that.settings_id !== null)
                HIBENCHMARKS.localStorageSet('chart_heights.' + that.settings_id, h);

            var now = Date.now();
            HIBENCHMARKS.options.last_page_scroll = now;
            HIBENCHMARKS.options.auto_refresher_stop_until = now + HIBENCHMARKS.options.current.stop_updates_while_resizing;
        ...
        this.resizeHandler = function(e) {
            ...
            var now = Date.now();
            if(now - this.event_resize.last <= HIBENCHMARKS.options.current.double_click_speed && this.element_legend_childs.perfect_scroller !== null) {
        ...
        var noDataToShow = function() {
            showMessageIcon(HIBENCHMARKS.icons.noData + ' empty');
        ...
        this.setSelection = function(t) {
            ...
            if (this.foreign_element_selection !== null)
                this.foreign_element_selection.innerText = HIBENCHMARKS.dateTime.localeDateString(t) + ' ' + HIBENCHMARKS.dateTime.localeTimeString(t);
        ...
        this.resetChart = function(dont_clear_master, dont_update) {
            ...
            if(dont_clear_master !== true && HIBENCHMARKS.globalPanAndZoom.isMaster(this) === true) {
                if(this.debug === true)
        ...
        this.updateChartPanOrZoom = function(after, before, callback) {
            ...
            HIBENCHMARKS.globalPanAndZoom.delay();
            HIBENCHMARKS.globalSelectionSync.delay();
            ...
            this.current.force_update_at = Date.now() + HIBENCHMARKS.options.current.pan_and_zoom_delay;
            this.current.force_after_ms = after;
            this.current.force_before_ms = before;
            HIBENCHMARKS.globalPanAndZoom.setMaster(this, after, before);
        ...
        this.updateChartPanOrZoomAsync = function(after, before, callback) {
            ...
            if(HIBENCHMARKS.globalPanAndZoom.isMaster(this) === false) {
                this.pauseChart();
                HIBENCHMARKS.globalPanAndZoom.setMaster(this, after, before);
                // HIBENCHMARKS.globalSelectionSync.stop();
                HIBENCHMARKS.globalSelectionSync.setMaster(this);
            }

            if(this.updateChartPanOrZoomAsyncTimeOutId)
                HIBENCHMARKS.timeout.clear(this.updateChartPanOrZoomAsyncTimeOutId);

            HIBENCHMARKS.timeout.set(function() {
        ...
        this.unitsConversionSetup = function(min, max) {
            if(this.units !== __unitsConversionLastUnits
                ...
                __unitsConversion = HIBENCHMARKS.unitsConversion.get(this.uuid, min, max, this.units, this.units_desired, this.units_common, function (units) {
        ...
        this.legendFormatValueDecimalsFromMinMax = function(min, max) {
            ...
            if(__legendFormatValueChartDecimals !== old) {
                if(__legendFormatValueChartDecimals < 0)
                    ...
                    __intlNumberFormat = HIBENCHMARKS.fastNumberFormat.get(
        ...
        this.legendFormatValue = function(value) {
            ...
            return HIBENCHMARKS.fastNumberFormat.get(dmin, dmax).format(value);
        };
        ...
        this.legendSetDate = function(ms) {
            ...
            if(this.legendSetDateLast.ms !== ms) {
                ...
                this.legendSetDateLast.date = HIBENCHMARKS.dateTime.localeDateString(d);
                this.legendSetDateLast.time = HIBENCHMARKS.dateTime.localeTimeString(d);
            }
        ...
        this.legendShowLatestValues = function() {
            ...
            if(Math.abs(this.hibenchmarks_last - this.view_before) <= this.data_update_every)
        ...
        this.__chartDimensionColor = function(label) {
            var c = HIBENCHMARKS.commonColors.get(this, label);
        ...
        this.chartPrepareColorPalette = function() {
            HIBENCHMARKS.commonColors.refill(this);
        };
        ...
        this.legendResolutionTooltip = function () {
            ...
            if(collected === viewed)
                return "resolution " + HIBENCHMARKS.seconds4human(collected);

            return "resolution " + HIBENCHMARKS.seconds4human(viewed) + ", collected every " + HIBENCHMARKS.seconds4human(collected);
        };
        ...
        this.legendUpdateDOM = function() {
            ...
            if(this.colors === null) {
                ...
                if(this.library.track_colors() === true) {
                    ...
                    len = keys.length;
                    for(i = 0; i < len ;i++)
                        HIBENCHMARKS.commonColors.get(this, this.chart.dimensions[keys[i]].name);
                }
            }
            ...
            var genLabel = function(state, parent, dim, name, count) {
                ...
                var user_id = HIBENCHMARKS.dataAttribute(state.element, 'show-value-of-' + name.toLowerCase() + '-at', null);
                if(user_id === null)
                    user_id = HIBENCHMARKS.dataAttribute(state.element, 'show-value-of-' + dim.toLowerCase() + '-at', null);
                if(user_id !== null) {
                ...
                var rgb = HIBENCHMARKS.colorHex2Rgb(color);
                label.name.innerHTML = '<table class="hibenchmarks-legend-name-table-'
                    + state.chart.chart_type
                    + '" style="background-color: '
                    + 'rgba(' + rgb.r + ',' + rgb.g + ',' + rgb.b + ',' + HIBENCHMARKS.options.current['color_fill_opacity_' + state.chart.chart_type] + ') !important'
                    + '"><tr class="hibenchmarks-legend-name-tr"><td class="hibenchmarks-legend-name-td"></td></tr></table>';
            ...
            if(this.element_chart === null) {
                ...
                if(this.hasLegend() === true)
                    this.element_chart.className = 'hibenchmarks-chart-with-legend-right hibenchmarks-' + this.library_name + '-chart-with-legend-right';
                else
                    this.element_chart.className = ' hibenchmarks-chart hibenchmarks-' + this.library_name + '-chart';
            }

            if(this.hasLegend() === true) {
                if(this.element_legend === null) {
                    this.element_legend = document.createElement('div');
                    this.element_legend.className = 'hibenchmarks-chart-legend hibenchmarks-' + this.library_name + '-legend';
                ...
                if(HIBENCHMARKS.options.current.legend_toolbox === true && this.library.toolboxPanAndZoom !== null) {
                    ...
                    var get_pan_and_zoom_step = function(event) {
                        if (event.ctrlKey)
                            return HIBENCHMARKS.options.current.pan_and_zoom_factor * HIBENCHMARKS.options.current.pan_and_zoom_factor_multiplier_control;

                        else if (event.shiftKey)
                            return HIBENCHMARKS.options.current.pan_and_zoom_factor * HIBENCHMARKS.options.current.pan_and_zoom_factor_multiplier_shift;

                        else if (event.altKey)
                            return HIBENCHMARKS.options.current.pan_and_zoom_factor * HIBENCHMARKS.options.current.pan_and_zoom_factor_multiplier_alt;

                        else
                            return HIBENCHMARKS.options.current.pan_and_zoom_factor;
                    };

                    this.element_legend_childs.toolbox.className += ' hibenchmarks-legend-toolbox';
                    this.element.appendChild(this.element_legend_childs.toolbox);

                    this.element_legend_childs.toolbox_left.className += ' hibenchmarks-legend-toolbox-button';
                    this.element_legend_childs.toolbox_left.innerHTML = HIBENCHMARKS.icons.left;
                    ...
                    this.element_legend_childs.toolbox_left.onclick = function(e) {
                        ...
                        if(after >= that.hibenchmarks_first)
                    ...
                    if(HIBENCHMARKS.options.current.show_help === true)
                        ...
                        trigger: 'hover',
                        placement: 'bottom',
                        delay: { show: HIBENCHMARKS.options.current.show_help_delay_show_ms, hide: HIBENCHMARKS.options.current.show_help_delay_hide_ms },
                        title: 'Pan Left',
                    ...
                    this.element_legend_childs.toolbox_reset.className += ' hibenchmarks-legend-toolbox-button';
                    this.element_legend_childs.toolbox_reset.innerHTML = HIBENCHMARKS.icons.reset;
                    ...
                    this.element_legend_childs.toolbox_reset.onclick = function(e) {
                        e.preventDefault();
                        HIBENCHMARKS.resetAllCharts(that);
                    };
                    if(HIBENCHMARKS.options.current.show_help === true)
                    ...
                    this.element_legend_childs.toolbox_right.className += ' hibenchmarks-legend-toolbox-button';
                    this.element_legend_childs.toolbox_right.innerHTML = HIBENCHMARKS.icons.right;
                    ...
                    this.element_legend_childs.toolbox_right.onclick = function(e) {
                        ...
                        var before = that.view_before + step;
                        var after = that.view_after + step;
                        if(before <= that.hibenchmarks_last)
                            that.library.toolboxPanAndZoom(that, after, before);
                    };
                    if(HIBENCHMARKS.options.current.show_help === true)
                    ...
                    this.element_legend_childs.toolbox_zoomin.className += ' hibenchmarks-legend-toolbox-button';
                    this.element_legend_childs.toolbox_zoomin.innerHTML = HIBENCHMARKS.icons.zoomIn;
                    ...
                    this.element_legend_childs.toolbox_zoomout.className += ' hibenchmarks-legend-toolbox-button';
                    this.element_legend_childs.toolbox_zoomout.innerHTML = HIBENCHMARKS.icons.zoomOut;
                    ...
                    //this.element_legend_childs.toolbox_volume.className += ' hibenchmarks-legend-toolbox-button';
                ...
                if(HIBENCHMARKS.options.current.resize_charts === true) {
                    this.element_legend_childs.resize_handler = document.createElement('div');

                    this.element_legend_childs.resize_handler.className += " hibenchmarks-legend-resize-handler";
                    this.element_legend_childs.resize_handler.innerHTML = HIBENCHMARKS.icons.resize;
                    ...
                    if (HIBENCHMARKS.options.current.show_help === true)
                        $(this.element_legend_childs.resize_handler).popover({
                            ...
                            placement: 'bottom',
                            delay: {
                                show: HIBENCHMARKS.options.current.show_help_delay_show_ms,
                                hide: HIBENCHMARKS.options.current.show_help_delay_hide_ms
                            },
                            title: 'Chart Resize',
                ...
                this.element_legend_childs.title_date.className += " hibenchmarks-legend-title-date";
                ...
                this.element_legend_childs.title_time.className += " hibenchmarks-legend-title-time";
                this.element_legend.appendChild(this.element_legend_childs.title_time);
                this.tmp.__last_shown_legend_time = undefined;

                this.element_legend.appendChild(document.createElement('br'));

                this.element_legend_childs.title_units.className += " hibenchmarks-legend-title-units";
                ...
                this.element_legend_childs.perfect_scroller.className = 'hibenchmarks-legend-series';
                this.element_legend.appendChild(this.element_legend_childs.perfect_scroller);

                content.className = 'hibenchmarks-legend-series-content';
        ...
        this.chartPixelsPerPoint = function() {
            ...
            if(px < HIBENCHMARKS.options.current.pixels_per_point)
                px = HIBENCHMARKS.options.current.pixels_per_point;
        ...
        this.needsRecreation = function() {
            var ret = (
                    ...
                    && this.tm.last_resized < HIBENCHMARKS.options.last_page_resize
                );
        ...
        this.chartURLOptions = function() {
            ...
            if(HIBENCHMARKS.options.current.eliminate_zero_dimensions === true)
                ret += '|nonzero';
        ...
        this.chartURL = function() {
            ...
            if(HIBENCHMARKS.globalPanAndZoom.isActive()) {
                if(this.current.force_before_ms !== null && this.current.force_after_ms !== null) {
                    ...
                    if(HIBENCHMARKS.options.current.pan_and_zoom_data_padding === true) {
                    ...
                    this.tm.pan_and_zoom_seq = HIBENCHMARKS.globalPanAndZoom.seq;

                    after = Math.round(HIBENCHMARKS.globalPanAndZoom.force_after_ms / 1000);
                    before = Math.round(HIBENCHMARKS.globalPanAndZoom.force_before_ms / 1000);
                    this.view_after = after * 1000;
                    this.view_before = before * 1000;
            ...
            var data_points;
            if(HIBENCHMARKS.options.force_data_points !== 0) {
                data_points = HIBENCHMARKS.options.force_data_points;
            ...
            if(HIBENCHMARKS.options.debug.chart_data_url === true || this.debug === true)
        ...
        this.updateChartWithData = function(data) {
            ...
            this.hibenchmarks_first = data.first_entry * 1000;
            this.hibenchmarks_last = data.last_entry * 1000;
            this.data_points = data.points;

            data.state = this;

            if(HIBENCHMARKS.options.current.pan_and_zoom_data_padding === true && this.requested_padding !== null) {
            ...
            if(HIBENCHMARKS.globalPanAndZoom.isActive())
                ...
                if(HIBENCHMARKS.options.current.parallel_refresher === true && HIBENCHMARKS.options.current.concurrent_refreshes === true && typeof this.force_update_every !== 'number')
            ...
            HIBENCHMARKS.options.auto_refresher_fast_weight += this.refresh_dt_ms;
            ...
            if(this.foreign_element_before !== null)
                this.foreign_element_before.innerText = HIBENCHMARKS.dateTime.localeDateString(this.view_before) + ' ' + HIBENCHMARKS.dateTime.localeTimeString(this.view_before);

            if(this.foreign_element_after !== null)
                this.foreign_element_after.innerText = HIBENCHMARKS.dateTime.localeDateString(this.view_after) + ' ' + HIBENCHMARKS.dateTime.localeTimeString(this.view_after);

            if(this.foreign_element_duration !== null)
                this.foreign_element_duration.innerText = HIBENCHMARKS.seconds4human(Math.floor((this.view_before - this.view_after) / 1000) + 1);

            if(this.foreign_element_update_every !== null)
                this.foreign_element_update_every.innerText = HIBENCHMARKS.seconds4human(Math.floor(this.data_update_every / 1000));
        };
        ...
        this.getSnapshotData = function(key) {
            ...
            if(typeof hibenchmarksSnapshotData.data[key] === 'undefined') {
                this.log('snapshot does not include data for key "' + key + '"');
                return null;
            }

            if(typeof hibenchmarksSnapshotData.data[key] !== 'string') {
            ...
            var uncompressed;
            try {
                uncompressed = hibenchmarksSnapshotData.uncompress(hibenchmarksSnapshotData.data[key]);
        ...
        this.updateChart = function(callback) {
            ...
            HIBENCHMARKS.statistics.refreshes_total++;
            HIBENCHMARKS.statistics.refreshes_active++;

            if(HIBENCHMARKS.statistics.refreshes_active > HIBENCHMARKS.statistics.refreshes_active_max)
                HIBENCHMARKS.statistics.refreshes_active_max = HIBENCHMARKS.statistics.refreshes_active;
            ...
            if(hibenchmarksSnapshotData !== null) {
                ...
                if (data !== null) {
                    ok = true;
                    data = HIBENCHMARKS.xss.checkData('/api/v1/data', data, this.library.xssRegexIgnore);
            ...
            .done(function(data) {
                data = HIBENCHMARKS.xss.checkData('/api/v1/data', data, that.library.xssRegexIgnore);
            ...
            .fail(function(msg) {
                ...
                if(msg.statusText !== 'abort') {
                    ...
                    if(that.retries_on_data_failures > HIBENCHMARKS.options.current.retries_on_data_failures) {
        ...
        this.isVisible = function(nocache) {
            // this.log('last_visible_check: ' + this.tm.last_visible_check + ', last_page_scroll: ' + HIBENCHMARKS.options.last_page_scroll);
            ...
            if((typeof nocache !== 'undefined' && nocache === true)
                ...
                || this.tm.last_visible_check <= HIBENCHMARKS.options.last_page_scroll) {
        ...
        this.canBeAutoRefreshed = function() {
            ...
            if(this.isVisible() === false) {
                if(HIBENCHMARKS.options.debug.visibility === true || this.debug === true)
            ...
            if(HIBENCHMARKS.options.page_is_visible === false && this.updates_counter && this.updates_since_last_unhide) {
                if(HIBENCHMARKS.options.debug.focus === true || this.debug === true)
            ...
            if(HIBENCHMARKS.options.auto_refresher_stop_until >= now) {
                if(this.debug === true)
            ...
            if(HIBENCHMARKS.globalPanAndZoom.isActive()) {
                if(HIBENCHMARKS.globalPanAndZoom.shouldBeAutoRefreshed(this)) {
                    if(this.debug === true)
        ...
        // fetch the chart description from the hibenchmarks server
        this.getChart = function(callback) {
            this.chart = HIBENCHMARKS.chartRegistry.get(this.host, this.id);
            if(this.chart) {
            ...
            else if(hibenchmarksSnapshotData !== null) {
                // console.log(this);
                // console.log(HIBENCHMARKS.chartRegistry);
                HIBENCHMARKS.error(404, 'host: ' + this.host + ', chart: ' +  this.id);
                ...
                .done(function(chart) {
                    chart = HIBENCHMARKS.xss.checkOptional('/api/v1/chart', chart);

                    chart.url = that.chart_url;
                    that.__defaultsFromDownloadedChart(chart);
                    HIBENCHMARKS.chartRegistry.add(that.host, that.id, chart);
                })
                .fail(function() {
                    HIBENCHMARKS.error(404, that.chart_url);
    ...
    HIBENCHMARKS.resetAllCharts = function(state) {
        ...
        var master = true;
        if(HIBENCHMARKS.globalPanAndZoom.isMaster(state) === false)
            master = false;
    ...
    HIBENCHMARKS.chartState = function(element) {
        var self = $(element);

        var state = self.data('hibenchmarks-state-object') || null;
        if(state === null) {
            state = new chartState(element);
            self.data('hibenchmarks-state-object', state);
        }
        return state;
    };
    ...
    HIBENCHMARKS._loadjQuery = function(callback) {
        if(typeof jQuery === 'undefined') {
            if(HIBENCHMARKS.options.debug.main_loop === true)
                console.log('loading ' + HIBENCHMARKS.jQuery);

            var script = document.createElement('script');
            script.type = 'text/javascript';
            script.async = true;
            script.src = HIBENCHMARKS.jQuery;

            // script.onabort = onError;
            script.onerror = function() { HIBENCHMARKS.error(101, HIBENCHMARKS.jQuery); };
            if(typeof callback === "function") {
    ...
    HIBENCHMARKS._loadCSS = function(filename) {
    ...
    HIBENCHMARKS.colorHex2Rgb = function(hex) {
    ...
    HIBENCHMARKS.colorLuminance = function(hex, lum) {
        // validate hex string
    ...
    HIBENCHMARKS.zeropad = function(x) {
    ...
    // updated.
    HIBENCHMARKS.updatedDom = function() {
        HIBENCHMARKS.options.updated_dom = true;
    };

    HIBENCHMARKS.ready = function(callback) {
        HIBENCHMARKS.options.pauseCallback = callback;
    };

    HIBENCHMARKS.pause = function(callback) {
        if(typeof callback === 'function') {
            if (HIBENCHMARKS.options.pause === true)
                return callback();
            else
                HIBENCHMARKS.options.pauseCallback = callback;
        }
    ...
    HIBENCHMARKS.unpause = function() {
        HIBENCHMARKS.options.pauseCallback = null;
        HIBENCHMARKS.options.updated_dom = true;
        HIBENCHMARKS.options.pause = false;
    };

    HIBENCHMARKS.seconds4human = function (seconds, options) {
        var default_options = {
            now: 'now',
            space: ' ',
            negative_suffix: 'ago',
    ...
    HIBENCHMARKS.chartRefresherNoParallel = function(index, callback) {
        var targets = HIBENCHMARKS.intersectionObserver.targets();

        if(HIBENCHMARKS.options.debug.main_loop === true)
            console.log('HIBENCHMARKS.chartRefresherNoParallel(' + index + ')');

        if(HIBENCHMARKS.options.updated_dom === true) {
            // the dom has been updated
            // get the dom parts again
            HIBENCHMARKS.parseDom(callback);
            return;
        }
        if(index >= targets.length) {
            ...
            HIBENCHMARKS.options.auto_refresher_fast_weight = 0;
            callback();
        }
        else {
            var state = targets[index];

            if(HIBENCHMARKS.options.auto_refresher_fast_weight < HIBENCHMARKS.options.current.fast_render_timeframe) {
                if(HIBENCHMARKS.options.debug.main_loop === true)
                ...
                if(state.isVisible() === true)
                    HIBENCHMARKS.timeout.set(function() {
                        state.autoRefresh(function () {
                            HIBENCHMARKS.chartRefresherNoParallel(++index, callback);
                        });
                    }, 0);
                else
                    HIBENCHMARKS.chartRefresherNoParallel(++index, callback);
                ...
                if(HIBENCHMARKS.options.debug.main_loop === true) console.log('waiting for next refresh...');
                HIBENCHMARKS.options.auto_refresher_fast_weight = 0;
                ...
                }, HIBENCHMARKS.options.current.idle_between_charts);
            }
        }
    };

    HIBENCHMARKS.chartRefresherWaitTime = function() {
        return HIBENCHMARKS.options.current.idle_parallel_loops;
    };

    // the default refresher
    HIBENCHMARKS.chartRefresherLastRun = 0;
    HIBENCHMARKS.chartRefresherRunsAfterParseDom = 0;
    HIBENCHMARKS.chartRefresherTimeoutId = undefined;

    HIBENCHMARKS.chartRefresherReschedule = function() {
        if(HIBENCHMARKS.options.current.async_on_scroll === true) {
            if(HIBENCHMARKS.chartRefresherTimeoutId)
                HIBENCHMARKS.timeout.clear(HIBENCHMARKS.chartRefresherTimeoutId);
            HIBENCHMARKS.chartRefresherTimeoutId = HIBENCHMARKS.timeout.set(HIBENCHMARKS.chartRefresher, HIBENCHMARKS.options.current.onscroll_worker_duration_threshold);
            //console.log('chartRefresherReschedule()');
        }
    };

    HIBENCHMARKS.chartRefresher = function() {
        // console.log('chartRefresher() begin ' + (Date.now() - HIBENCHMARKS.chartRefresherLastRun).toString() + ' ms since last run');

        if(HIBENCHMARKS.options.page_is_visible === false
            && HIBENCHMARKS.options.current.stop_updates_when_focus_is_lost === true
            && HIBENCHMARKS.chartRefresherLastRun > HIBENCHMARKS.options.last_page_resize
            && HIBENCHMARKS.chartRefresherLastRun > HIBENCHMARKS.options.last_page_scroll
            && HIBENCHMARKS.chartRefresherRunsAfterParseDom > 10
        ) {
            setTimeout(
                HIBENCHMARKS.chartRefresher,
                HIBENCHMARKS.options.current.idle_lost_focus
            );

            // console.log('chartRefresher() page without focus, will run in ' + HIBENCHMARKS.options.current.idle_lost_focus.toString() + ' ms, ' + HIBENCHMARKS.chartRefresherRunsAfterParseDom.toString());
            return;
        }
        HIBENCHMARKS.chartRefresherRunsAfterParseDom++;

        var now = Date.now();
        HIBENCHMARKS.chartRefresherLastRun = now;

        if( now < HIBENCHMARKS.options.on_scroll_refresher_stop_until ) {
            HIBENCHMARKS.chartRefresherTimeoutId = HIBENCHMARKS.timeout.set(
                HIBENCHMARKS.chartRefresher,
                HIBENCHMARKS.chartRefresherWaitTime()
            );

            // console.log('chartRefresher() end1 will run in ' + HIBENCHMARKS.chartRefresherWaitTime().toString() + ' ms');
            return;
        }

        if( now < HIBENCHMARKS.options.auto_refresher_stop_until ) {
            HIBENCHMARKS.chartRefresherTimeoutId = HIBENCHMARKS.timeout.set(
                HIBENCHMARKS.chartRefresher,
                HIBENCHMARKS.chartRefresherWaitTime()
            );

            // console.log('chartRefresher() end2 will run in ' + HIBENCHMARKS.chartRefresherWaitTime().toString() + ' ms');
            return;
        }
        ...
        if(HIBENCHMARKS.options.pause === true) {
            ...
            // console.log('chartRefresher() end3 will run in ' + HIBENCHMARKS.chartRefresherWaitTime().toString() + ' ms');
            return;
        }

        if(typeof HIBENCHMARKS.options.pauseCallback === 'function') {
            // console.log('auto-refresher is calling pauseCallback');

            HIBENCHMARKS.options.pause = true;
            HIBENCHMARKS.options.pauseCallback();
            HIBENCHMARKS.chartRefresher();
        ...
        if(HIBENCHMARKS.options.current.parallel_refresher === false) {
            ...
            HIBENCHMARKS.chartRefresherNoParallel(0, function() {
                HIBENCHMARKS.chartRefresherTimeoutId = HIBENCHMARKS.timeout.set(
                    HIBENCHMARKS.chartRefresher,
                    HIBENCHMARKS.options.current.idle_between_loops
                );
            });
        ...
        if(HIBENCHMARKS.options.updated_dom === true) {
            ...
            HIBENCHMARKS.parseDom(HIBENCHMARKS.chartRefresher);
            // console.log('chartRefresher() end6 (parseDom)');
            return;
        }

        if(HIBENCHMARKS.globalSelectionSync.active() === false) {
            var parallel = [];
            var targets = HIBENCHMARKS.intersectionObserver.targets();
            var len = targets.length;
            var state;
            while(len--) {
                ...
                if(state.library.initialized === false) {
                    if(state.library.enabled === true) {
                        state.library.initialize(HIBENCHMARKS.chartRefresher);
            ...
            while (len--) {
                ...
                if (state.running === false)
                    HIBENCHMARKS.timeout.set(state.autoRefresh, 0);
            }
            //else {
    ...
    HIBENCHMARKS.parseDom = function(callback) {
        //console.log('parseDom()');

        HIBENCHMARKS.options.last_page_scroll = Date.now();
        HIBENCHMARKS.options.updated_dom = false;
        HIBENCHMARKS.chartRefresherRunsAfterParseDom = 0;

        var targets = $('div[data-hibenchmarks]'); //.filter(':visible');

        if(HIBENCHMARKS.options.debug.main_loop === true)
            console.log('DOM updated - there are ' + targets.length + ' charts on page.');

        HIBENCHMARKS.intersectionObserver.globalReset();
        HIBENCHMARKS.options.targets = [];
        var len = targets.length;
        while(len--) {
            // the initialization will take care of sizing
            // and the "loading..." message
            var state = HIBENCHMARKS.chartState(targets[len]);
            HIBENCHMARKS.options.targets.push(state);
            HIBENCHMARKS.intersectionObserver.observe(state);
        }

        if(HIBENCHMARKS.globalChartUnderlay.isActive() === true)
            HIBENCHMARKS.globalChartUnderlay.setup();
        else
            HIBENCHMARKS.globalChartUnderlay.clear();
    ...
    HIBENCHMARKS.started = false;
    HIBENCHMARKS.start = function() {
        // this should be called only once

        if(HIBENCHMARKS.started === true) {
            console.log('hibenchmarks is already started');
            return;
        }

        HIBENCHMARKS.started = true;
        HIBENCHMARKS.options.page_is_visible = true;

        $(window).blur(function() {
            if(HIBENCHMARKS.options.current.stop_updates_when_focus_is_lost === true) {
                HIBENCHMARKS.options.page_is_visible = false;
                if(HIBENCHMARKS.options.debug.focus === true)
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', HIBENCHMARKS.onscroll);

        // bootstrap modal switching
        var $modal = $('.modal');
        $modal.on('hidden.bs.modal', HIBENCHMARKS.onscroll);
        $modal.on('shown.bs.modal', HIBENCHMARKS.onscroll);

        // bootstrap collapse switching
        var $collapse = $('.collapse');
        $collapse.on('hidden.bs.collapse', HIBENCHMARKS.onscroll);
        $collapse.on('shown.bs.collapse', HIBENCHMARKS.onscroll);

        HIBENCHMARKS.parseDom(HIBENCHMARKS.chartRefresher);

        // Alarms initialization
        setTimeout(HIBENCHMARKS.alarms.init, 1000);

        // Registry initialization
        setTimeout(HIBENCHMARKS.registry.init, hibenchmarksRegistryAfterMs);

        if(typeof hibenchmarksCallback === 'function')
            hibenchmarksCallback();
    };

    HIBENCHMARKS.globalReset = function() {
        HIBENCHMARKS.intersectionObserver.globalReset();
        HIBENCHMARKS.globalSelectionSync.globalReset();
        HIBENCHMARKS.globalPanAndZoom.globalReset();
        HIBENCHMARKS.chartRegistry.globalReset();
        HIBENCHMARKS.commonMin.globalReset();
        HIBENCHMARKS.commonMax.globalReset();
        HIBENCHMARKS.commonColors.globalReset();
        HIBENCHMARKS.unitsConversion.globalReset();
        HIBENCHMARKS.options.targets = [];
        HIBENCHMARKS.parseDom();
        HIBENCHMARKS.unpause();
    };

    // ----------------------------------------------------------------------------------------------------------------
    // peity

    HIBENCHMARKS.peityInitialize = function(callback) {
        if(typeof hibenchmarksNoPeitys === 'undefined' || !hibenchmarksNoPeitys) {
            $.ajax({
                url: HIBENCHMARKS.peity_js,
                cache: true,
                dataType: "script",
                xhrFields: { withCredentials: true } // required for the cookie
            })
            .done(function() {
                HIBENCHMARKS.registerChartLibrary('peity', HIBENCHMARKS.peity_js);
            })
            .fail(function() {
                HIBENCHMARKS.chartLibraries.peity.enabled = false;
                HIBENCHMARKS.error(100, HIBENCHMARKS.peity_js);
            })
            .always(function() {
                if(typeof callback === "function")
                    return callback();
    ...
    HIBENCHMARKS.peityChartUpdate = function(state, data) {
        ...
        if(state.peity_options.stroke !== state.chartCustomColors()[0]) {
            ...
            if(state.chart.chart_type === 'line')
                state.peity_options.fill = HIBENCHMARKS.themes.current.background;
            else
                state.peity_options.fill = HIBENCHMARKS.colorLuminance(state.chartCustomColors()[0], HIBENCHMARKS.chartDefaults.fill_luminance);
        }
    ...
    HIBENCHMARKS.peityChartCreate = function(state, data) {
        state.peity_instance = document.createElement('div');
        state.element_chart.appendChild(state.peity_instance);

        state.peity_options = {
            stroke: HIBENCHMARKS.themes.current.foreground,
            strokeWidth: HIBENCHMARKS.dataAttribute(state.element, 'peity-strokewidth', 1),
            width: state.chartWidth(),
            height: state.chartHeight(),
            fill: HIBENCHMARKS.themes.current.foreground
        };

        HIBENCHMARKS.peityChartUpdate(state, data);
        return true;
    };
    ...
    HIBENCHMARKS.sparklineInitialize = function(callback) {
        if(typeof hibenchmarksNoSparklines === 'undefined' || !hibenchmarksNoSparklines) {
            $.ajax({
                url: HIBENCHMARKS.sparkline_js,
                cache: true,
                dataType: "script",
                xhrFields: { withCredentials: true } // required for the cookie
            })
            .done(function() {
                HIBENCHMARKS.registerChartLibrary('sparkline', HIBENCHMARKS.sparkline_js);
            })
            .fail(function() {
                HIBENCHMARKS.chartLibraries.sparkline.enabled = false;
                HIBENCHMARKS.error(100, HIBENCHMARKS.sparkline_js);
            })
            .always(function() {
                if(typeof callback === "function")
                    return callback();
    ...
    HIBENCHMARKS.sparklineChartUpdate = function(state, data) {
    ...
    HIBENCHMARKS.sparklineChartCreate = function(state, data) {
        var type = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-type', 'line');
        var lineColor = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-linecolor', state.chartCustomColors()[0]);
        var fillColor = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-fillcolor', ((state.chart.chart_type === 'line')?HIBENCHMARKS.themes.current.background:HIBENCHMARKS.colorLuminance(lineColor, HIBENCHMARKS.chartDefaults.fill_luminance)));
        var chartRangeMin = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-chartrangemin', undefined);
        var chartRangeMax = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-chartrangemax', undefined);
        var composite = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-composite', undefined);
        var enableTagOptions = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-enabletagoptions', undefined);
        var tagOptionPrefix = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tagoptionprefix', undefined);
        var tagValuesAttribute = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tagvaluesattribute', undefined);
        var disableHiddenCheck = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-disablehiddencheck', undefined);
        var defaultPixelsPerValue = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-defaultpixelspervalue', undefined);
        var spotColor = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-spotcolor', undefined);
        var minSpotColor = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-minspotcolor', undefined);
        var maxSpotColor = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-maxspotcolor', undefined);
        var spotRadius = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-spotradius', undefined);
        var valueSpots = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-valuespots', undefined);
        var highlightSpotColor = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-highlightspotcolor', undefined);
        var highlightLineColor = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-highlightlinecolor', undefined);
        var lineWidth = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-linewidth', undefined);
        var normalRangeMin = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-normalrangemin', undefined);
        var normalRangeMax = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-normalrangemax', undefined);
        var drawNormalOnTop = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-drawnormalontop', undefined);
        var xvalues = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-xvalues', undefined);
        var chartRangeClip = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-chartrangeclip', undefined);
        var chartRangeMinX = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-chartrangeminx', undefined);
        var chartRangeMaxX = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-chartrangemaxx', undefined);
        var disableInteraction = HIBENCHMARKS.dataAttributeBoolean(state.element, 'sparkline-disableinteraction', false);
        var disableTooltips = HIBENCHMARKS.dataAttributeBoolean(state.element, 'sparkline-disabletooltips', false);
        var disableHighlight = HIBENCHMARKS.dataAttributeBoolean(state.element, 'sparkline-disablehighlight', false);
        var highlightLighten = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-highlightlighten', 1.4);
        var highlightColor = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-highlightcolor', undefined);
        var tooltipContainer = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tooltipcontainer', undefined);
        var tooltipClassname = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tooltipclassname', undefined);
        var tooltipFormat = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tooltipformat', undefined);
        var tooltipPrefix = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tooltipprefix', undefined);
        var tooltipSuffix = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tooltipsuffix', ' ' + state.units_current);
        var tooltipSkipNull = HIBENCHMARKS.dataAttributeBoolean(state.element, 'sparkline-tooltipskipnull', true);
        var tooltipValueLookups = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tooltipvaluelookups', undefined);
        var tooltipFormatFieldlist = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tooltipformatfieldlist', undefined);
        var tooltipFormatFieldlistKey = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-tooltipformatfieldlistkey', undefined);
        var numberFormatter = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-numberformatter', function(n){ return n.toFixed(2); });
        var numberDigitGroupSep = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-numberdigitgroupsep', undefined);
        var numberDecimalMark = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-numberdecimalmark', undefined);
        var numberDigitGroupCount = HIBENCHMARKS.dataAttribute(state.element, 'sparkline-numberdigitgroupcount', undefined);
        var animatedZooms = HIBENCHMARKS.dataAttributeBoolean(state.element, 'sparkline-animatedzooms', false);
    ...
    HIBENCHMARKS.dygraph = {
        smooth: false
    };

    HIBENCHMARKS.dygraphToolboxPanAndZoom = function(state, after, before) {
        if(after < state.hibenchmarks_first)
            after = state.hibenchmarks_first;

        if(before > state.hibenchmarks_last)
            before = state.hibenchmarks_last;
        ...
        HIBENCHMARKS.globalPanAndZoom.setMaster(state, after, before);
    };

    HIBENCHMARKS.dygraphSetSelection = function(state, t) {
    ...
    HIBENCHMARKS.dygraphClearSelection = function(state) {
        if(typeof state.tmp.dygraph_instance !== 'undefined') {
            state.tmp.dygraph_instance.clearSelection();
        }
        return true;
    ...
    HIBENCHMARKS.dygraphSmoothInitialize = function(callback) {
        $.ajax({
            url: HIBENCHMARKS.dygraph_smooth_js,
            cache: true,
            dataType: "script",
            xhrFields: { withCredentials: true } // required for the cookie
        })
        .done(function() {
            HIBENCHMARKS.dygraph.smooth = true;
            smoothPlotter.smoothing = 0.3;
        })
        .fail(function() {
            HIBENCHMARKS.dygraph.smooth = false;
        })
        .always(function() {
            if(typeof callback === "function")
                return callback();
    ...
    HIBENCHMARKS.dygraphInitialize = function(callback) {
        if(typeof hibenchmarksNoDygraphs === 'undefined' || !hibenchmarksNoDygraphs) {
            $.ajax({
                url: HIBENCHMARKS.dygraph_js,
                cache: true,
                dataType: "script",
                xhrFields: { withCredentials: true } // required for the cookie
            })
            .done(function() {
                HIBENCHMARKS.registerChartLibrary('dygraph', HIBENCHMARKS.dygraph_js);
            })
            .fail(function() {
                HIBENCHMARKS.chartLibraries.dygraph.enabled = false;
                HIBENCHMARKS.error(100, HIBENCHMARKS.dygraph_js);
            })
            .always(function() {
                if(HIBENCHMARKS.chartLibraries.dygraph.enabled === true && HIBENCHMARKS.options.current.smooth_plot === true)
                    HIBENCHMARKS.dygraphSmoothInitialize(callback);
                else if(typeof callback === "function")
                    return callback();
            });
        }
    ...
    HIBENCHMARKS.dygraphChartUpdate = function(state, data) {
        var dygraph = state.tmp.dygraph_instance;

        if(typeof dygraph === 'undefined')
            return HIBENCHMARKS.dygraphChartCreate(state, data);
        ...
        if(!HIBENCHMARKS.chartLibraries.dygraph.isSparkline(state)) {
            options.ylabel = state.units_current; // (state.units_desired === 'auto')?"":state.units_current;
        }

        if(state.tmp.dygraph_force_zoom === true) {
            if(HIBENCHMARKS.options.debug.dygraph === true || state.debug === true)
        ...
        if (state.tmp.__commonMin !== null) {
            ...
            oldMin = options.valueRange[0] = HIBENCHMARKS.commonMin.get(state);
        }
        if (state.tmp.__commonMax !== null) {
            state.data.max = state.tmp.dygraph_instance.axes_[0].extremeRange[1];
            oldMax = options.valueRange[1] = HIBENCHMARKS.commonMax.get(state);
        }

        if(state.tmp.dygraph_smooth_eligible === true) {
            if((HIBENCHMARKS.options.current.smooth_plot === true && state.tmp.dygraph_options.plotter !== smoothPlotter)
                || (HIBENCHMARKS.options.current.smooth_plot === false && state.tmp.dygraph_options.plotter === smoothPlotter)) {
                HIBENCHMARKS.dygraphChartCreate(state, data);
                return;
            }
        }

        if(hibenchmarksSnapshotData !== null && HIBENCHMARKS.globalPanAndZoom.isActive() === true && HIBENCHMARKS.globalPanAndZoom.isMaster(state) === false) {
            // pan and zoom on snapshots
            options.dateWindow = [ HIBENCHMARKS.globalPanAndZoom.force_after_ms, HIBENCHMARKS.globalPanAndZoom.force_before_ms ];
            //options.isZoomedIgnoreProgrammaticZoom = true;
        }

        if(HIBENCHMARKS.chartLibraries.dygraph.isLogScale(state) === true) {
        ...
        if(oldMin !== null && oldMin > state.tmp.dygraph_instance.axes_[0].extremeRange[0]) {
            state.data.min = state.tmp.dygraph_instance.axes_[0].extremeRange[0];
            options.valueRange[0] = HIBENCHMARKS.commonMin.get(state);
            redraw = true;
        }
        if(oldMax !== null && oldMax < state.tmp.dygraph_instance.axes_[0].extremeRange[1]) {
            state.data.max = state.tmp.dygraph_instance.axes_[0].extremeRange[1];
            options.valueRange[1] = HIBENCHMARKS.commonMax.get(state);
            redraw = true;
        }
    ...
    HIBENCHMARKS.dygraphChartCreate = function(state, data) {
        if(HIBENCHMARKS.options.debug.dygraph === true || state.debug === true)
            state.log('dygraphChartCreate()');

        state.tmp.dygraph_chart_type = HIBENCHMARKS.dataAttribute(state.element, 'dygraph-type', state.chart.chart_type);
        if(state.tmp.dygraph_chart_type === 'stacked' && data.dimensions === 1) state.tmp.dygraph_chart_type = 'area';
        if(state.tmp.dygraph_chart_type === 'stacked' && HIBENCHMARKS.chartLibraries.dygraph.isLogScale(state) === true) state.tmp.dygraph_chart_type = 'area';

        var highlightCircleSize = (HIBENCHMARKS.chartLibraries.dygraph.isSparkline(state) === true)?3:4;

        var smooth = (HIBENCHMARKS.dygraph.smooth === true)
            ?(HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-smooth', (state.tmp.dygraph_chart_type === 'line' && HIBENCHMARKS.chartLibraries.dygraph.isSparkline(state) === false)))
            :false;

        state.tmp.dygraph_include_zero = HIBENCHMARKS.dataAttribute(state.element, 'dygraph-includezero', (state.tmp.dygraph_chart_type === 'stacked'));
        var drawAxis = HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-drawaxis', true);

        state.tmp.dygraph_options = {
            colors:                 HIBENCHMARKS.dataAttribute(state.element, 'dygraph-colors', state.chartColors()),

            // leave a few pixels empty on the right of the chart
            rightGap:               HIBENCHMARKS.dataAttribute(state.element, 'dygraph-rightgap', 5),
            showRangeSelector:      HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-showrangeselector', false),
            showRoller:             HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-showroller', false),
            title:                  HIBENCHMARKS.dataAttribute(state.element, 'dygraph-title', state.title),
            titleHeight:            HIBENCHMARKS.dataAttribute(state.element, 'dygraph-titleheight', 19),
            legend:                 HIBENCHMARKS.dataAttribute(state.element, 'dygraph-legend', 'always'), // we need this to get selection events
            labels:                 data.result.labels,
            labelsDiv:              HIBENCHMARKS.dataAttribute(state.element, 'dygraph-labelsdiv', state.element_legend_childs.hidden),
            //labelsDivStyles:        HIBENCHMARKS.dataAttribute(state.element, 'dygraph-labelsdivstyles', { 'fontSize':'1px' }),
            //labelsDivWidth:         HIBENCHMARKS.dataAttribute(state.element, 'dygraph-labelsdivwidth', state.chartWidth() - 70),
            labelsSeparateLines:    HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-labelsseparatelines', true),
            labelsShowZeroValues:   (HIBENCHMARKS.chartLibraries.dygraph.isLogScale(state) === true)?false:HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-labelsshowzerovalues', true),
            labelsKMB:              false,
            labelsKMG2:             false,
            showLabelsOnHighlight:  HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-showlabelsonhighlight', true),
            hideOverlayOnMouseOut:  HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-hideoverlayonmouseout', true),
            includeZero:            state.tmp.dygraph_include_zero,
            xRangePad:              HIBENCHMARKS.dataAttribute(state.element, 'dygraph-xrangepad', 0),
            yRangePad:              HIBENCHMARKS.dataAttribute(state.element, 'dygraph-yrangepad', 1),
            valueRange:             HIBENCHMARKS.dataAttribute(state.element, 'dygraph-valuerange', [ null, null ]),
            ylabel:                 state.units_current, // (state.units_desired === 'auto')?"":state.units_current,
            yLabelWidth:            HIBENCHMARKS.dataAttribute(state.element, 'dygraph-ylabelwidth', 12),
            ...
            strokeWidth:            HIBENCHMARKS.dataAttribute(state.element, 'dygraph-strokewidth', ((state.tmp.dygraph_chart_type === 'stacked')?0.1:((smooth === true)?1.5:0.7))),
            strokePattern:          HIBENCHMARKS.dataAttribute(state.element, 'dygraph-strokepattern', undefined),
            ...
            drawPoints:             HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-drawpoints', false),

                                    // Draw points at the edges of gaps in the data.
                                    // This improves visibility of small data segments or other data irregularities.
            drawGapEdgePoints:      HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-drawgapedgepoints', true),
            connectSeparatedPoints: (HIBENCHMARKS.chartLibraries.dygraph.isLogScale(state) === true)?false:HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-connectseparatedpoints', false),
            pointSize:              HIBENCHMARKS.dataAttribute(state.element, 'dygraph-pointsize', 1),

                                    // enabling this makes the chart with little square lines
            stepPlot:               HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-stepplot', false),

                                    // Draw a border around graph lines to make crossing lines more easily
                                    // distinguishable. Useful for graphs with many lines.
            strokeBorderColor:      HIBENCHMARKS.dataAttribute(state.element, 'dygraph-strokebordercolor', HIBENCHMARKS.themes.current.background),
            strokeBorderWidth:      HIBENCHMARKS.dataAttribute(state.element, 'dygraph-strokeborderwidth', (state.tmp.dygraph_chart_type === 'stacked')?0.0:0.0),
            fillGraph:              HIBENCHMARKS.dataAttribute(state.element, 'dygraph-fillgraph', (state.tmp.dygraph_chart_type === 'area' || state.tmp.dygraph_chart_type === 'stacked')),
            fillAlpha:              HIBENCHMARKS.dataAttribute(state.element, 'dygraph-fillalpha',
                                    ((state.tmp.dygraph_chart_type === 'stacked')
                                        ?HIBENCHMARKS.options.current.color_fill_opacity_stacked
                                        :HIBENCHMARKS.options.current.color_fill_opacity_area)
                                    ),
            stackedGraph:           HIBENCHMARKS.dataAttribute(state.element, 'dygraph-stackedgraph', (state.tmp.dygraph_chart_type === 'stacked')),
            stackedGraphNaNFill:    HIBENCHMARKS.dataAttribute(state.element, 'dygraph-stackedgraphnanfill', 'none'),
            drawAxis:               drawAxis,
            axisLabelFontSize:      HIBENCHMARKS.dataAttribute(state.element, 'dygraph-axislabelfontsize', 10),
            axisLineColor:          HIBENCHMARKS.dataAttribute(state.element, 'dygraph-axislinecolor', HIBENCHMARKS.themes.current.axis),
            axisLineWidth:          HIBENCHMARKS.dataAttribute(state.element, 'dygraph-axislinewidth', 1.0),
            drawGrid:               HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-drawgrid', true),
            gridLinePattern:        HIBENCHMARKS.dataAttribute(state.element, 'dygraph-gridlinepattern', null),
            gridLineWidth:          HIBENCHMARKS.dataAttribute(state.element, 'dygraph-gridlinewidth', 1.0),
            gridLineColor:          HIBENCHMARKS.dataAttribute(state.element, 'dygraph-gridlinecolor', HIBENCHMARKS.themes.current.grid),
            maxNumberWidth:         HIBENCHMARKS.dataAttribute(state.element, 'dygraph-maxnumberwidth', 8),
            sigFigs:                HIBENCHMARKS.dataAttribute(state.element, 'dygraph-sigfigs', null),
            digitsAfterDecimal:     HIBENCHMARKS.dataAttribute(state.element, 'dygraph-digitsafterdecimal', 2),
            valueFormatter:         HIBENCHMARKS.dataAttribute(state.element, 'dygraph-valueformatter', undefined),
            highlightCircleSize:    HIBENCHMARKS.dataAttribute(state.element, 'dygraph-highlightcirclesize', highlightCircleSize),
            highlightSeriesOpts:    HIBENCHMARKS.dataAttribute(state.element, 'dygraph-highlightseriesopts', null), // TOO SLOW: { strokeWidth: 1.5 },
            highlightSeriesBackgroundAlpha: HIBENCHMARKS.dataAttribute(state.element, 'dygraph-highlightseriesbackgroundalpha', null), // TOO SLOW: (state.tmp.dygraph_chart_type === 'stacked')?0.7:0.5,
            pointClickCallback:     HIBENCHMARKS.dataAttribute(state.element, 'dygraph-pointclickcallback', undefined),
            visibility:             state.dimensions_visibility.selected2BooleanArray(state.data.dimension_names),
            logscale:               (HIBENCHMARKS.chartLibraries.dygraph.isLogScale(state) === true)?'y':undefined,

            axes: {
                x: {
                    pixelsPerLabel: HIBENCHMARKS.dataAttribute(state.element, 'dygraph-xpixelsperlabel', 50),
                    ticker: Dygraph.dateTicker,
                    axisLabelWidth: HIBENCHMARKS.dataAttribute(state.element, 'dygraph-xaxislabelwidth', 60),
                    drawAxis: HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-drawxaxis', drawAxis),
                    axisLabelFormatter: function (d, gran) {
                        void(gran);
                        return HIBENCHMARKS.dateTime.xAxisTimeString(d);
                    }
                },
                y: {
                    logscale: (HIBENCHMARKS.chartLibraries.dygraph.isLogScale(state) === true)?true:undefined,
                    pixelsPerLabel: HIBENCHMARKS.dataAttribute(state.element, 'dygraph-ypixelsperlabel', 15),
                    axisLabelWidth: HIBENCHMARKS.dataAttribute(state.element, 'dygraph-yaxislabelwidth', 50),
                    drawAxis: HIBENCHMARKS.dataAttributeBoolean(state.element, 'dygraph-drawyaxis', drawAxis),
                    axisLabelFormatter: function (y) {
                        ...
                        if(state.units_desired === 'auto' && typeof old_units !== 'undefined' && new_units !== old_units && !HIBENCHMARKS.chartLibraries.dygraph.isSparkline(state)) {
                            // console.log(this);
            ...
            highlightCallback: function(event, x, points, row, seriesName) {
                ...
                if(state.tmp.dygraph_mouse_down !== true)
                    HIBENCHMARKS.globalSelectionSync.sync(state, x);
            ...
            underlayCallback: function(canvas, area, g) {
                ...
                if(HIBENCHMARKS.globalChartUnderlay.isActive()) {
                    var after = HIBENCHMARKS.globalChartUnderlay.after;
                    var before = HIBENCHMARKS.globalChartUnderlay.before;
                    ...
                    if(after < before) {
                        ...
                        canvas.fillStyle = HIBENCHMARKS.themes.current.highlight;
            ...
            interactionModel : {
                ...
                mouseup: function(event, dygraph, context) {
                    ...
                    if(state.tmp.dygraph_highlight_after !== null) {
                        ...
                        HIBENCHMARKS.globalChartUnderlay.set(state
                ...
                dblclick: function(event, dygraph, context) {
                    ...
                    HIBENCHMARKS.resetAllCharts(state);
                },
                wheel: function(event, dygraph, context) {
                    ...
                    if(event.altKey || event.shiftKey) {
                        ...
                        var first = state.hibenchmarks_first + state.data_update_every;
                        var last = state.hibenchmarks_last + state.data_update_every;
                ...
                touchend: function(event, dygraph, context) {
                    ...
                    if(state.dygraph_last_touch_move === 0 && state.dygraph_last_touch_page_x !== 0) {
                        HIBENCHMARKS.globalSelectionSync.dont_sync_before = 0;
                        HIBENCHMARKS.globalSelectionSync.setMaster(state);
                        ...
                        if(HIBENCHMARKS.dygraphSetSelection(state, t) === true) {
                            HIBENCHMARKS.globalSelectionSync.sync(state, t);
                        }
                    }
                    ...
                    if(typeof state.dygraph_last_touch_end !== 'undefined') {
                        if(state.dygraph_last_touch_move === 0) {
                            ...
                            if(dt <= HIBENCHMARKS.options.current.double_click_speed)
                                HIBENCHMARKS.resetAllCharts(state);
                        }
                    }
        ...
        if(HIBENCHMARKS.chartLibraries.dygraph.isSparkline(state) === true) {
        ...
        if(smooth === true) {
            ...
            if(HIBENCHMARKS.options.current.smooth_plot === true)
        ...
        if(hibenchmarksSnapshotData !== null && HIBENCHMARKS.globalPanAndZoom.isActive() === true && HIBENCHMARKS.globalPanAndZoom.isMaster(state) === false) {
            // pan and zoom on snapshots
            state.tmp.dygraph_options.dateWindow = [ HIBENCHMARKS.globalPanAndZoom.force_after_ms, HIBENCHMARKS.globalPanAndZoom.force_before_ms ];
    ...
    HIBENCHMARKS.morrisInitialize = function(callback) {
        if(typeof hibenchmarksNoMorris === 'undefined' || !hibenchmarksNoMorris) {

            // morris requires raphael
            if(!HIBENCHMARKS.chartLibraries.raphael.initialized) {
                if(HIBENCHMARKS.chartLibraries.raphael.enabled) {
                    HIBENCHMARKS.raphaelInitialize(function() {
                        HIBENCHMARKS.morrisInitialize(callback);
                    });
                }
                else {
                    HIBENCHMARKS.chartLibraries.morris.enabled = false;
                    if(typeof callback === "function")
                        return callback();
                }
            }
            else {
                HIBENCHMARKS._loadCSS(HIBENCHMARKS.morris_css);

                $.ajax({
                    url: HIBENCHMARKS.morris_js,
                    cache: true,
                    dataType: "script",
                    xhrFields: { withCredentials: true } // required for the cookie
                })
                .done(function() {
                    HIBENCHMARKS.registerChartLibrary('morris', HIBENCHMARKS.morris_js);
                })
                .fail(function() {
                    HIBENCHMARKS.chartLibraries.morris.enabled = false;
                    HIBENCHMARKS.error(100, HIBENCHMARKS.morris_js);
                })
                .always(function() {
                    if(typeof callback === "function")
                        return callback();
    ...
    HIBENCHMARKS.morrisChartUpdate = function(state, data) {
        state.morris_instance.setData(data.result.data);
        return true;
    };

    HIBENCHMARKS.morrisChartCreate = function(state, data) {
    ...
    HIBENCHMARKS.raphaelInitialize = function(callback) {
        if(typeof hibenchmarksStopRaphael === 'undefined' || !hibenchmarksStopRaphael) {
            $.ajax({
                url: HIBENCHMARKS.raphael_js,
                cache: true,
                dataType: "script",
                xhrFields: { withCredentials: true } // required for the cookie
            })
            .done(function() {
                HIBENCHMARKS.registerChartLibrary('raphael', HIBENCHMARKS.raphael_js);
            })
            .fail(function() {
                HIBENCHMARKS.chartLibraries.raphael.enabled = false;
                HIBENCHMARKS.error(100, HIBENCHMARKS.raphael_js);
            })
            .always(function() {
                if(typeof callback === "function")
                    return callback();
    ...
    HIBENCHMARKS.raphaelChartUpdate = function(state, data) {
    ...
    HIBENCHMARKS.raphaelChartCreate = function(state, data) {
        $(state.element_chart).raphael(data.result, {
            width: state.chartWidth(),
            height: state.chartHeight()
        });
    ...
    HIBENCHMARKS.c3Initialize = function(callback) {
        if(typeof hibenchmarksNoC3 === 'undefined' || !hibenchmarksNoC3) {

            // C3 requires D3
            if(!HIBENCHMARKS.chartLibraries.d3.initialized) {
                if(HIBENCHMARKS.chartLibraries.d3.enabled) {
                    HIBENCHMARKS.d3Initialize(function() {
                        HIBENCHMARKS.c3Initialize(callback);
                    });
                }
                else {
                    HIBENCHMARKS.chartLibraries.c3.enabled = false;
                    if(typeof callback === "function")
                        return callback();
                }
            }
            else {
                HIBENCHMARKS._loadCSS(HIBENCHMARKS.c3_css);

                $.ajax({
                    url: HIBENCHMARKS.c3_js,
                    cache: true,
                    dataType: "script",
                    xhrFields: { withCredentials: true } // required for the cookie
                })
                .done(function() {
                    HIBENCHMARKS.registerChartLibrary('c3', HIBENCHMARKS.c3_js);
                })
                .fail(function() {
                    HIBENCHMARKS.chartLibraries.c3.enabled = false;
                    HIBENCHMARKS.error(100, HIBENCHMARKS.c3_js);
                })
                .always(function() {
                    if(typeof callback === "function")
                        return callback();
    ...
    HIBENCHMARKS.c3ChartUpdate = function(state, data) {
        state.c3_instance.destroy();
        return HIBENCHMARKS.c3ChartCreate(state, data);
    ...
    HIBENCHMARKS.c3ChartCreate = function(state, data) {
        ...
        state.c3_instance = c3.generate({
            ...
            axis: {
                x: {
                    ...
                    tick: {
                        format: function(x) {
                            return HIBENCHMARKS.dateTime.xAxisTimeString(x);
                        }
                    }
                }
            },
    ...
    HIBENCHMARKS.d3pieInitialize = function(callback) {
        if(typeof hibenchmarksNoD3pie === 'undefined' || !hibenchmarksNoD3pie) {

            // d3pie requires D3
            if(!HIBENCHMARKS.chartLibraries.d3.initialized) {
                if(HIBENCHMARKS.chartLibraries.d3.enabled) {
                    HIBENCHMARKS.d3Initialize(function() {
                        HIBENCHMARKS.d3pieInitialize(callback);
                    });
                }
                else {
                    HIBENCHMARKS.chartLibraries.d3pie.enabled = false;
                    if(typeof callback === "function")
                        return callback();
                }
            }
                ...
                $.ajax({
                    url: HIBENCHMARKS.d3pie_js,
                    cache: true,
                    dataType: "script",
                    xhrFields: { withCredentials: true } // required for the cookie
                })
                    .done(function() {
                        HIBENCHMARKS.registerChartLibrary('d3pie', HIBENCHMARKS.d3pie_js);
                    })
                    .fail(function() {
                        HIBENCHMARKS.chartLibraries.d3pie.enabled = false;
                        HIBENCHMARKS.error(100, HIBENCHMARKS.d3pie_js);
                    })
                    .always(function() {
                        if(typeof callback === "function")
                            return callback();
    ...
    HIBENCHMARKS.d3pieSetContent = function(state, data, index) {
        state.legendFormatValueDecimalsFromMinMax(
            data.min,
            data.max
        );
    ...
    HIBENCHMARKS.d3pieDateRange = function(state, data, index) {
        var dt = Math.round((data.before - data.after + 1) / data.points);
        var dt_str = HIBENCHMARKS.seconds4human(dt);

        var before = data.result.data[index].time;
        var after = before - (dt * 1000);

        var d1 = HIBENCHMARKS.dateTime.localeDateString(after);
        var t1 = HIBENCHMARKS.dateTime.localeTimeString(after);
        var d2 = HIBENCHMARKS.dateTime.localeDateString(before);
        var t2 = HIBENCHMARKS.dateTime.localeTimeString(before);
    ...
    HIBENCHMARKS.d3pieSetSelection = function(state, t) {
        if(state.timeIsVisible(t) !== true)
            return HIBENCHMARKS.d3pieClearSelection(state, true);
        ...
        if(state.tmp.d3pie_timer === undefined) {
            state.tmp.d3pie_timer = HIBENCHMARKS.timeout.set(function() {
                state.tmp.d3pie_timer = undefined;
                HIBENCHMARKS.d3pieChange(state, HIBENCHMARKS.d3pieSetContent(state, state.data, slot), HIBENCHMARKS.d3pieDateRange(state, state.data, slot));
            }, 0);
        }
    ...
    HIBENCHMARKS.d3pieClearSelection = function(state, force) {
        if(typeof state.tmp.d3pie_timer !== 'undefined') {
            HIBENCHMARKS.timeout.clear(state.tmp.d3pie_timer);
            state.tmp.d3pie_timer = undefined;
        }

        if(state.isAutoRefreshable() === true && state.data !== null && force !== true) {
            HIBENCHMARKS.d3pieChartUpdate(state, state.data);
        }
        else {
            if(state.tmp.d3pie_last_slot !== -1) {
                state.tmp.d3pie_last_slot = -1;
                HIBENCHMARKS.d3pieChange(state, [{label: 'no data', value: 1, color: '#666666'}], 'no data available');
            }
        }
    ...
    HIBENCHMARKS.d3pieChange = function(state, content, footer) {
    ...
    HIBENCHMARKS.d3pieChartUpdate = function(state, data) {
        return HIBENCHMARKS.d3pieChange(state, HIBENCHMARKS.d3pieSetContent(state, data, 0), HIBENCHMARKS.d3pieDateRange(state, data, 0));
    };

    HIBENCHMARKS.d3pieChartCreate = function(state, data) {

        state.element_chart.id = 'd3pie-' + state.uuid;
        // console.log('id = ' + state.element_chart.id);

        var content = HIBENCHMARKS.d3pieSetContent(state, data, 0);

        state.d3pie_forced_title = HIBENCHMARKS.dataAttribute(state.element, 'd3pie-title', null);
        state.d3pie_forced_subtitle = HIBENCHMARKS.dataAttribute(state.element, 'd3pie-subtitle', null);
        state.d3pie_forced_footer = HIBENCHMARKS.dataAttribute(state.element, 'd3pie-footer', null);

        state.d3pie_options = {
            header: {
                title: {
                    text: (state.d3pie_forced_title !== null) ? state.d3pie_forced_title : state.title,
                    color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-title-color', HIBENCHMARKS.themes.current.d3pie.title),
                    fontSize: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-title-fontsize', 12),
                    fontWeight: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-title-fontweight', "bold"),
                    font: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-title-font', "arial")
                },
                subtitle: {
                    text: (state.d3pie_forced_subtitle !== null) ? state.d3pie_forced_subtitle : state.units_current,
                    color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-subtitle-color', HIBENCHMARKS.themes.current.d3pie.subtitle),
                    fontSize: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-subtitle-fontsize', 10),
                    fontWeight: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-subtitle-fontweight', "normal"),
                    font: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-subtitle-font', "arial")
                },
                titleSubtitlePadding: 1
            },
            footer: {
                text: (state.d3pie_forced_footer !== null) ? state.d3pie_forced_footer : HIBENCHMARKS.d3pieDateRange(state, data, 0),
                color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-footer-color', HIBENCHMARKS.themes.current.d3pie.footer),
                fontSize: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-footer-fontsize', 9),
                fontWeight: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-footer-fontweight', "bold"),
                font: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-footer-font', "arial"),
                location: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-footer-location', "bottom-center") // bottom-left, bottom-center, bottom-right
            },
            size: {
                canvasHeight: state.chartHeight(),
                canvasWidth: state.chartWidth(),
                pieInnerRadius: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-pieinnerradius', "45%"),
                pieOuterRadius: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-pieouterradius', "80%")
            },
            data: {
                // none, random, value-asc, value-desc, label-asc, label-desc
                sortOrder: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-sortorder', "value-desc"),
                smallSegmentGrouping: {
                    enabled: HIBENCHMARKS.dataAttributeBoolean(state.element, "d3pie-smallsegmentgrouping-enabled", false),
                    value: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-smallsegmentgrouping-value', 1),
                    // percentage, value
                    valueType: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-smallsegmentgrouping-valuetype', "percentage"),
                    label: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-smallsegmentgrouping-label', "other"),
                    color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-smallsegmentgrouping-color', HIBENCHMARKS.themes.current.d3pie.other)
                },
            ...
            labels: {
                outer: {
                    ...
                    format: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-outer-format', "label-value1"),
                    hideWhenLessThanPercentage: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-outer-hidewhenlessthanpercentage', null),
                    pieDistance: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-outer-piedistance', 15)
                },
                inner: {
                    // label, value, percentage, label-value1, label-value2, label-percentage1, label-percentage2
                    format: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-inner-format', "percentage"),
                    hideWhenLessThanPercentage: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-inner-hidewhenlessthanpercentage', 2)
                },
                mainLabel: {
                    color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-mainLabel-color', HIBENCHMARKS.themes.current.d3pie.mainlabel), // or 'segment' for dynamic color
                    font: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-mainLabel-font', "arial"),
                    fontSize: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-mainLabel-fontsize', 10),
                    fontWeight: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-mainLabel-fontweight', "normal")
                },
                percentage: {
                    color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-percentage-color', HIBENCHMARKS.themes.current.d3pie.percentage),
                    font: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-percentage-font', "arial"),
                    fontSize: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-percentage-fontsize', 10),
                    fontWeight: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-percentage-fontweight', "bold"),
                    decimalPlaces: 0
                },
                value: {
                    color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-value-color', HIBENCHMARKS.themes.current.d3pie.value),
                    font: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-value-font', "arial"),
                    fontSize: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-value-fontsize', 10),
                    fontWeight: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-value-fontweight', "bold")
                },
                lines: {
                    enabled: HIBENCHMARKS.dataAttributeBoolean(state.element, 'd3pie-labels-lines-enabled', true),
                    style: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-lines-style', "curved"),
                    color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-lines-color', "segment") // "segment" or a hex color
                },
                truncation: {
                    enabled: HIBENCHMARKS.dataAttributeBoolean(state.element, 'd3pie-labels-truncation-enabled', false),
                    truncateLength: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-labels-truncation-truncatelength', 30)
                },
            ...
            tooltips: {
                ...
                styles: {
                    fadeInSpeed: 250,
                    backgroundColor: HIBENCHMARKS.themes.current.d3pie.tooltip_bg,
                    backgroundOpacity: 0.5,
                    color: HIBENCHMARKS.themes.current.d3pie.tooltip_fg,
                    borderRadius: 2,
                    font: "arial",
                    fontSize: 12,
                    padding: 4
            ...
            misc: {
                colors: {
                    ...
                    segmentStroke: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-misc-colors-segmentstroke', HIBENCHMARKS.themes.current.d3pie.segment_stroke)
                },
                gradient: {
                    enabled: HIBENCHMARKS.dataAttributeBoolean(state.element, 'd3pie-misc-gradient-enabled', false),
                    percentage: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-misc-colors-percentage', 95),
                    color: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-misc-gradient-color', HIBENCHMARKS.themes.current.d3pie.gradient_color)
                },
                canvasPadding: {
                    top: 5,
                    right: 5,
                ...
                cssPrefix: HIBENCHMARKS.dataAttribute(state.element, 'd3pie-cssprefix', null)
            },
            callbacks: {
                onload: null,
    ...
    HIBENCHMARKS.d3Initialize = function(callback) {
        if(typeof hibenchmarksStopD3 === 'undefined' || !hibenchmarksStopD3) {
            $.ajax({
                url: HIBENCHMARKS.d3_js,
                cache: true,
                dataType: "script",
                xhrFields: { withCredentials: true } // required for the cookie
            })
            .done(function() {
                HIBENCHMARKS.registerChartLibrary('d3', HIBENCHMARKS.d3_js);
            })
            .fail(function() {
                HIBENCHMARKS.chartLibraries.d3.enabled = false;
                HIBENCHMARKS.error(100, HIBENCHMARKS.d3_js);
            })
            .always(function() {
                if(typeof callback === "function")
                    return callback();
    ...
    HIBENCHMARKS.d3ChartUpdate = function(state, data) {
        void(state);
        void(data);
    ...
    HIBENCHMARKS.d3ChartCreate = function(state, data) {
        void(state);
        void(data);
    ...
    HIBENCHMARKS.googleInitialize = function(callback) {
        if(typeof hibenchmarksNoGoogleCharts === 'undefined' || !hibenchmarksNoGoogleCharts) {
            $.ajax({
                url: HIBENCHMARKS.google_js,
                cache: true,
                dataType: "script",
                xhrFields: { withCredentials: true } // required for the cookie
            })
            .done(function() {
                HIBENCHMARKS.registerChartLibrary('google', HIBENCHMARKS.google_js);
            ...
            .fail(function() {
                HIBENCHMARKS.chartLibraries.google.enabled = false;
                HIBENCHMARKS.error(100, HIBENCHMARKS.google_js);
                if(typeof callback === "function")
                    return callback();
            });
        }
    ...
    HIBENCHMARKS.googleChartCreate = function(state, data) {
        ...
        switch(state.chart.chart_type) {
            case "area":
                ...
                state.google_options.areaOpacity = HIBENCHMARKS.options.current.color_fill_opacity_area;
                state.google_instance = new google.visualization.AreaChart(state.element_chart);
                break;

            case "stacked":
                state.google_options.isStacked = true;
                state.google_options.areaOpacity = HIBENCHMARKS.options.current.color_fill_opacity_stacked;
                state.google_options.vAxis.viewWindowMode = 'maximized';
    ...
    HIBENCHMARKS.easypiechartPercentFromValueMinMax = function(state, value, min, max) {
    ...
    HIBENCHMARKS.easypiechartInitialize = function(callback) {
        if(typeof hibenchmarksNoEasyPieChart === 'undefined' || !hibenchmarksNoEasyPieChart) {
            $.ajax({
                url: HIBENCHMARKS.easypiechart_js,
                cache: true,
                dataType: "script",
                xhrFields: { withCredentials: true } // required for the cookie
            })
                .done(function() {
                    HIBENCHMARKS.registerChartLibrary('easypiechart', HIBENCHMARKS.easypiechart_js);
                })
                .fail(function() {
                    HIBENCHMARKS.chartLibraries.easypiechart.enabled = false;
                    HIBENCHMARKS.error(100, HIBENCHMARKS.easypiechart_js);
                })
                .always(function() {
                    if(typeof callback === "function")
                        return callback();
    ...
    HIBENCHMARKS.easypiechartClearSelection = function(state, force) {
        if(typeof state.tmp.easyPieChartEvent !== 'undefined' && typeof state.tmp.easyPieChartEvent.timer !== 'undefined') {
            HIBENCHMARKS.timeout.clear(state.tmp.easyPieChartEvent.timer);
            state.tmp.easyPieChartEvent.timer = undefined;
        }

        if(state.isAutoRefreshable() === true && state.data !== null && force !== true) {
            HIBENCHMARKS.easypiechartChartUpdate(state, state.data);
        }
        else {
    ...
    HIBENCHMARKS.easypiechartSetSelection = function(state, t) {
        if(state.timeIsVisible(t) !== true)
            return HIBENCHMARKS.easypiechartClearSelection(state, true);
        ...
        var min = (state.tmp.easyPieChartMin === null)?HIBENCHMARKS.commonMin.get(state):state.tmp.easyPieChartMin;
        var max = (state.tmp.easyPieChartMax === null)?HIBENCHMARKS.commonMax.get(state):state.tmp.easyPieChartMax;
        var pcent = HIBENCHMARKS.easypiechartPercentFromValueMinMax(state, value, min, max);
        ...
        if(state.tmp.easyPieChartEvent.timer === undefined) {
            ...
            state.tmp.easyPieChartEvent.timer = HIBENCHMARKS.timeout.set(function() {
                state.tmp.easyPieChartEvent.timer = undefined;
    ...
    HIBENCHMARKS.easypiechartChartUpdate = function(state, data) {
        var value, min, max, pcent;

        if(HIBENCHMARKS.globalPanAndZoom.isActive() === true || state.isAutoRefreshable() === false) {
            value = null;
            pcent = 0;
        }
        else {
            value = data.result[0];
            min = (state.tmp.easyPieChartMin === null)?HIBENCHMARKS.commonMin.get(state):state.tmp.easyPieChartMin;
            max = (state.tmp.easyPieChartMax === null)?HIBENCHMARKS.commonMax.get(state):state.tmp.easyPieChartMax;
            pcent = HIBENCHMARKS.easypiechartPercentFromValueMinMax(state, value, min, max);
        }
    ...
    HIBENCHMARKS.easypiechartChartCreate = function(state, data) {
        var chart = $(state.element_chart);

        var value = data.result[0];
        var min = HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-min-value', null);
        var max = HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-max-value', null);

        if(min === null) {
            min = HIBENCHMARKS.commonMin.get(state);
        ...
        if(max === null) {
            max = HIBENCHMARKS.commonMax.get(state);
        ...
        var barColor = HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-barcolor', undefined);
        ...
        chart.easyPieChart({
            barColor: barColor,
            trackColor: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-trackcolor', HIBENCHMARKS.themes.current.easypiechart_track),
            scaleColor: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-scalecolor', HIBENCHMARKS.themes.current.easypiechart_scale),
            scaleLength: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-scalelength', 5),
            lineCap: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-linecap', 'round'),
            lineWidth: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-linewidth', stroke),
            trackWidth: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-trackwidth', undefined),
            size: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-size', size),
            rotate: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-rotate', 0),
            animate: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-animate', {duration: 500, enabled: true}),
            easing: HIBENCHMARKS.dataAttribute(state.element, 'easypiechart-easing', undefined)
        });
        ...
        state.legendShowUndefined = function() {
            if(typeof state.tmp.easyPieChart_instance !== 'undefined')
                HIBENCHMARKS.easypiechartClearSelection(state);
        };
    ...
    HIBENCHMARKS.gaugeInitialize = function(callback) {
        if(typeof hibenchmarksNoGauge === 'undefined' || !hibenchmarksNoGauge) {
            $.ajax({
                url: HIBENCHMARKS.gauge_js,
                cache: true,
                dataType: "script",
                xhrFields: { withCredentials: true } // required for the cookie
            })
                .done(function() {
                    HIBENCHMARKS.registerChartLibrary('gauge', HIBENCHMARKS.gauge_js);
                })
                .fail(function() {
                    HIBENCHMARKS.chartLibraries.gauge.enabled = false;
                    HIBENCHMARKS.error(100, HIBENCHMARKS.gauge_js);
                })
                .always(function() {
                    if(typeof callback === "function")
                        return callback();
    ...
    HIBENCHMARKS.gaugeAnimation = function(state, status) {
        var speed = 32;
    ...
    HIBENCHMARKS.gaugeSet = function(state, value, min, max) {
        if(typeof value !== 'number') value = 0;
        if(typeof min !== 'number') min = 0;
        if(typeof max !== 'number') max = 0;
    ...
    HIBENCHMARKS.gaugeSetLabels = function(state, value, min, max) {
    ...
    HIBENCHMARKS.gaugeClearSelection = function(state, force) {
        if(typeof state.tmp.gaugeEvent !== 'undefined' && typeof state.tmp.gaugeEvent.timer !== 'undefined') {
            HIBENCHMARKS.timeout.clear(state.tmp.gaugeEvent.timer);
            state.tmp.gaugeEvent.timer = undefined;
        }

        if(state.isAutoRefreshable() === true && state.data !== null && force !== true) {
            HIBENCHMARKS.gaugeChartUpdate(state, state.data);
        }
        else {
            HIBENCHMARKS.gaugeAnimation(state, false);
            HIBENCHMARKS.gaugeSetLabels(state, null, null, null);
            HIBENCHMARKS.gaugeSet(state, null, null, null);
        }

        HIBENCHMARKS.gaugeAnimation(state, true);
        return true;
    };

    HIBENCHMARKS.gaugeSetSelection = function(state, t) {
        if(state.timeIsVisible(t) !== true)
            return HIBENCHMARKS.gaugeClearSelection(state, true);
        ...
        var value = state.data.result[state.data.result.length - 1 - slot];
        var min = (state.tmp.gaugeMin === null)?HIBENCHMARKS.commonMin.get(state):state.tmp.gaugeMin;
        var max = (state.tmp.gaugeMax === null)?HIBENCHMARKS.commonMax.get(state):state.tmp.gaugeMax;
        ...
        HIBENCHMARKS.gaugeSetLabels(state, value, min, max);

        if(state.tmp.gaugeEvent.timer === undefined) {
            HIBENCHMARKS.gaugeAnimation(state, false);

            state.tmp.gaugeEvent.timer = HIBENCHMARKS.timeout.set(function() {
                state.tmp.gaugeEvent.timer = undefined;
                HIBENCHMARKS.gaugeSet(state, state.tmp.gaugeEvent.value, state.tmp.gaugeEvent.min, state.tmp.gaugeEvent.max);
            }, 0);
        }
    ...
    HIBENCHMARKS.gaugeChartUpdate = function(state, data) {
        var value, min, max;
        ...
        if(HIBENCHMARKS.globalPanAndZoom.isActive() === true || state.isAutoRefreshable() === false) {
            ...
            value = data.result[0];
            min = (state.tmp.gaugeMin === null)?HIBENCHMARKS.commonMin.get(state):state.tmp.gaugeMin;
            max = (state.tmp.gaugeMax === null)?HIBENCHMARKS.commonMax.get(state):state.tmp.gaugeMax;
            if(value < min) min = value;
            if(value > max) max = value;
            ...
            HIBENCHMARKS.gaugeSet(state, value, min, max);
            HIBENCHMARKS.gaugeSetLabels(state, value, min, max);
        }
    ...
    HIBENCHMARKS.gaugeChartCreate = function(state, data) {
        // var chart = $(state.element_chart);

        var value = data.result[0];
        var min = HIBENCHMARKS.dataAttribute(state.element, 'gauge-min-value', null);
        var max = HIBENCHMARKS.dataAttribute(state.element, 'gauge-max-value', null);
        // var adjust = HIBENCHMARKS.dataAttribute(state.element, 'gauge-adjust', null);
        var pointerColor = HIBENCHMARKS.dataAttribute(state.element, 'gauge-pointer-color', HIBENCHMARKS.themes.current.gauge_pointer);
        var strokeColor = HIBENCHMARKS.dataAttribute(state.element, 'gauge-stroke-color', HIBENCHMARKS.themes.current.gauge_stroke);
        var startColor = HIBENCHMARKS.dataAttribute(state.element, 'gauge-start-color', state.chartCustomColors()[0]);
        var stopColor = HIBENCHMARKS.dataAttribute(state.element, 'gauge-stop-color', void 0);
        var generateGradient = HIBENCHMARKS.dataAttribute(state.element, 'gauge-generate-gradient', false);
        ...
        if (generateGradient.constructor === Array) {
            ...
            while(len--) {
                ...
                var color = HIBENCHMARKS.dataAttribute(state.element, 'gauge-gradient-percent-color-' + pcent.toString(), false);
                if(color !== false) {
                    var a = [];
                    a[0] = pcent / 100;
                    a[1] = color;
        ...
        else if(generateGradient === false && HIBENCHMARKS.themes.current.gauge_gradient === true) {
            //noinspection PointlessArithmeticExpressionJS
            options.percentColors = [
                [0.0, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 0))],
                [0.1, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 1))],
                [0.2, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 2))],
                [0.3, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 3))],
                [0.4, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 4))],
                [0.5, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 5))],
                [0.6, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 6))],
                [0.7, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 7))],
                [0.8, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 8))],
                [0.9, HIBENCHMARKS.colorLuminance(startColor, (lum_d * 10) - (lum_d * 9))],
                [1.0, HIBENCHMARKS.colorLuminance(startColor, 0.0)]];
        }
        ...
        HIBENCHMARKS.gaugeAnimation(state, animate);
        HIBENCHMARKS.gaugeSet(state, value, min, max);
        HIBENCHMARKS.gaugeSetLabels(state, value, min, max);
        HIBENCHMARKS.gaugeAnimation(state, true);
        ...
        state.legendShowUndefined = function() {
            if(typeof state.tmp.gauge_instance !== 'undefined')
                HIBENCHMARKS.gaugeClearSelection(state);
        };
    ...
    HIBENCHMARKS.chartLibraries = {
        "dygraph": {
            initialize: HIBENCHMARKS.dygraphInitialize,
            create: HIBENCHMARKS.dygraphChartCreate,
            update: HIBENCHMARKS.dygraphChartUpdate,
            ...
            setSelection: HIBENCHMARKS.dygraphSetSelection,
            clearSelection:  HIBENCHMARKS.dygraphClearSelection,
            toolboxPanAndZoom: HIBENCHMARKS.dygraphToolboxPanAndZoom,
            initialized: false,
            enabled: true,
            ...
            legend: function(state) {
                return (this.isSparkline(state) === false && HIBENCHMARKS.dataAttributeBoolean(state.element, 'legend', true) === true) ? 'right-side' : null;
            },
            ...
            theme: function(state) {
                if(typeof state.tmp.dygraph_theme === 'undefined')
                    state.tmp.dygraph_theme = HIBENCHMARKS.dataAttribute(state.element, 'dygraph-theme', 'default');
                return state.tmp.dygraph_theme;
            },
            container_class: function(state) {
                if(this.legend(state) !== null)
                    return 'hibenchmarks-container-with-legend';
                return 'hibenchmarks-container';
            }
        },
        "sparkline": {
            initialize: HIBENCHMARKS.sparklineInitialize,
            create: HIBENCHMARKS.sparklineChartCreate,
            update: HIBENCHMARKS.sparklineChartUpdate,
            resize: null,
            ...
            container_class: function(state) { void(state); return 'hibenchmarks-container'; }
        },
        "peity": {
            initialize: HIBENCHMARKS.peityInitialize,
            create: HIBENCHMARKS.peityChartCreate,
            update: HIBENCHMARKS.peityChartUpdate,
            resize: null,
            setSelection: undefined, // function(state, t) { void(state); return true; },
            clearSelection: undefined, // function(state) { void(state); return true; },
            toolboxPanAndZoom: null,
        ...
        "morris": {
            initialize: HIBENCHMARKS.morrisInitialize,
            create: HIBENCHMARKS.morrisChartCreate,
            update: HIBENCHMARKS.morrisChartUpdate,
            resize: null,
            setSelection: undefined, // function(state, t) { void(state); return true; },
            clearSelection: undefined, // function(state) { void(state); return true; },
            toolboxPanAndZoom: null,
        ...
        "google": {
            initialize: HIBENCHMARKS.googleInitialize,
            create: HIBENCHMARKS.googleChartCreate,
            update: HIBENCHMARKS.googleChartUpdate,
            resize: null,
            setSelection: undefined, //function(state, t) { void(state); return true; },
            clearSelection: undefined, //function(state) { void(state); return true; },
            toolboxPanAndZoom: null,
        ...
        "raphael": {
            initialize: HIBENCHMARKS.raphaelInitialize,
            create: HIBENCHMARKS.raphaelChartCreate,
            update: HIBENCHMARKS.raphaelChartUpdate,
            resize: null,
            setSelection: undefined, // function(state, t) { void(state); return true; },
            clearSelection: undefined, // function(state) { void(state); return true; },
            toolboxPanAndZoom: null,
        ...
        "c3": {
            initialize: HIBENCHMARKS.c3Initialize,
            create: HIBENCHMARKS.c3ChartCreate,
            update: HIBENCHMARKS.c3ChartUpdate,
            resize: null,
            setSelection: undefined, // function(state, t) { void(state); return true; },
            clearSelection: undefined, // function(state) { void(state); return true; },
            toolboxPanAndZoom: null,
        ...
        "d3pie": {
            initialize: HIBENCHMARKS.d3pieInitialize,
            create: HIBENCHMARKS.d3pieChartCreate,
            update: HIBENCHMARKS.d3pieChartUpdate,
            resize: null,
            setSelection: HIBENCHMARKS.d3pieSetSelection,
            clearSelection: HIBENCHMARKS.d3pieClearSelection,
            toolboxPanAndZoom: null,
            initialized: false,
            enabled: true,
            xssRegexIgnore: new RegExp('^/api/v1/data\.result.data$'),
        ...
        "d3": {
            initialize: HIBENCHMARKS.d3Initialize,
            create: HIBENCHMARKS.d3ChartCreate,
            update: HIBENCHMARKS.d3ChartUpdate,
            resize: null,
            setSelection: undefined, // function(state, t) { void(state); return true; },
            clearSelection: undefined, // function(state) { void(state); return true; },
            toolboxPanAndZoom: null,
        ...
        "easypiechart": {
            initialize: HIBENCHMARKS.easypiechartInitialize,
            create: HIBENCHMARKS.easypiechartChartCreate,
            update: HIBENCHMARKS.easypiechartChartUpdate,
            resize: null,
            setSelection: HIBENCHMARKS.easypiechartSetSelection,
            clearSelection: HIBENCHMARKS.easypiechartClearSelection,
            toolboxPanAndZoom: null,
            initialized: false,
            enabled: true,
            xssRegexIgnore: new RegExp('^/api/v1/data\.result$'),
            ...
            pixels_per_point: function(state) { void(state); return 3; },
            aspect_ratio: 100,
            container_class: function(state) { void(state); return 'hibenchmarks-container-easypiechart'; }
        },
        "gauge": {
            initialize: HIBENCHMARKS.gaugeInitialize,
            create: HIBENCHMARKS.gaugeChartCreate,
            update: HIBENCHMARKS.gaugeChartUpdate,
            resize: null,
            setSelection: HIBENCHMARKS.gaugeSetSelection,
            clearSelection: HIBENCHMARKS.gaugeClearSelection,
            toolboxPanAndZoom: null,
            initialized: false,
            enabled: true,
            xssRegexIgnore: new RegExp('^/api/v1/data\.result$'),
            ...
            pixels_per_point: function(state) { void(state); return 3; },
            aspect_ratio: 60,
            container_class: function(state) { void(state); return 'hibenchmarks-container-gauge'; }
        }
    };

    HIBENCHMARKS.registerChartLibrary = function(library, url) {
        if(HIBENCHMARKS.options.debug.libraries === true)
            console.log("registering chart library: " + library);

        HIBENCHMARKS.chartLibraries[library].url = url;
        HIBENCHMARKS.chartLibraries[library].initialized = true;
        HIBENCHMARKS.chartLibraries[library].enabled = true;
    };

    // ----------------------------------------------------------------------------------------------------------------
    // Load required JS libraries and CSS

    HIBENCHMARKS.requiredJs = [
        {
            url: HIBENCHMARKS.serverStatic + 'lib/bootstrap-3.3.7.min.js',
            async: false,
            isAlreadyLoaded: function() {
                ...
                if(typeof $().emulateTransitionEnd === 'function')
                    ...
                    return (typeof hibenchmarksNoBootstrap !== 'undefined' && hibenchmarksNoBootstrap === true);
                }
            }
        },
        {
            url: HIBENCHMARKS.serverStatic + 'lib/fontawesome-all-5.0.1.min.js',
            async: true,
            isAlreadyLoaded: function() {
                return (typeof hibenchmarksNoFontAwesome !== 'undefined' && hibenchmarksNoFontAwesome === true);
            }
        },
        {
            url: HIBENCHMARKS.serverStatic + 'lib/perfect-scrollbar-0.6.15.min.js',
            isAlreadyLoaded: function() { return false; }
        }
    ];

    HIBENCHMARKS.requiredCSS = [
        {
            url: HIBENCHMARKS.themes.current.bootstrap_css,
            isAlreadyLoaded: function() {
                return (typeof hibenchmarksNoBootstrap !== 'undefined' && hibenchmarksNoBootstrap === true);
            }
        },
        {
            url: HIBENCHMARKS.themes.current.dashboard_css,
            isAlreadyLoaded: function() { return false; }
        }
    ];

    HIBENCHMARKS.loadedRequiredJs = 0;
    HIBENCHMARKS.loadRequiredJs = function(index, callback) {
        if(index >= HIBENCHMARKS.requiredJs.length) {
            if(typeof callback === 'function')
                return callback();
            return;
        }

        if(HIBENCHMARKS.requiredJs[index].isAlreadyLoaded()) {
            HIBENCHMARKS.loadedRequiredJs++;
            HIBENCHMARKS.loadRequiredJs(++index, callback);
            return;
        }

        if(HIBENCHMARKS.options.debug.main_loop === true)
            console.log('loading ' + HIBENCHMARKS.requiredJs[index].url);

        var async = true;
        if(typeof HIBENCHMARKS.requiredJs[index].async !== 'undefined' && HIBENCHMARKS.requiredJs[index].async === false)
            async = false;

        $.ajax({
            url: HIBENCHMARKS.requiredJs[index].url,
            cache: true,
            dataType: "script",
            xhrFields: { withCredentials: true } // required for the cookie
        })
        .done(function() {
            if(HIBENCHMARKS.options.debug.main_loop === true)
                console.log('loaded ' + HIBENCHMARKS.requiredJs[index].url);
        })
        .fail(function() {
            alert('Cannot load required JS library: ' + HIBENCHMARKS.requiredJs[index].url);
        })
        .always(function() {
            HIBENCHMARKS.loadedRequiredJs++;
    ...
    HIBENCHMARKS.loadRequiredCSS = function(index) {
        if(index >= HIBENCHMARKS.requiredCSS.length)
            return;

        if(HIBENCHMARKS.requiredCSS[index].isAlreadyLoaded()) {
            HIBENCHMARKS.loadRequiredCSS(++index);
            return;
        }

        if(HIBENCHMARKS.options.debug.main_loop === true)
            console.log('loading ' + HIBENCHMARKS.requiredCSS[index].url);

        HIBENCHMARKS._loadCSS(HIBENCHMARKS.requiredCSS[index].url);
        HIBENCHMARKS.loadRequiredCSS(++index);
    };


    // ----------------------------------------------------------------------------------------------------------------
    // Registry of hibenchmarks hosts
    ...
    HIBENCHMARKS.alarms = {
        ...
        chart_div_id_prefix: 'chart_',  // the chart DIV IDs have this prefix (they should be HIBENCHMARKS.name2id(chart.id))
        ...
        callback: (typeof hibenchmarksAlarmsActiveCallback === 'function')?hibenchmarksAlarmsActiveCallback:null,
        ...
        notificationCallback: (typeof hibenchmarksAlarmsNotifCallback === 'function')?hibenchmarksAlarmsNotifCallback:null,
        ...
        activeForRecipients: function() {
            var active = {};
            var data = HIBENCHMARKS.alarms.current;
            ...
            for(var x in data.alarms) {
                ...
                if((alarm.status === 'WARNING' || alarm.status === 'CRITICAL') && HIBENCHMARKS.alarms.recipientMatches(alarm.recipient, HIBENCHMARKS.alarms.recipients))
                    active[x] = alarm;
            }
        ...
        notify: function(entry) {
            ...
            if(HIBENCHMARKS.alarms.current !== null) {
                // get the current value_string
                var t = HIBENCHMARKS.alarms.current.alarms[entry.chart + '.' + entry.name];
            ...
            switch(entry.status) {
                ...
                case 'CLEAR':
                    if(entry.unique_id < HIBENCHMARKS.alarms.first_notification_id) {
            ...
            // filter recipients
            if(show === true)
                show = HIBENCHMARKS.alarms.recipientMatches(entry.recipient, HIBENCHMARKS.alarms.recipients);

            /*
            // cleanup old notifications with the same alarm_id as this one
            // FIXME: it does not seem to work on any web browser!
            var len = HIBENCHMARKS.alarms.notifications_shown.length;
            while(len--) {
                var n = HIBENCHMARKS.alarms.notifications_shown[len];
                if(n.data.alarm_id === entry.alarm_id) {
                    ...
                    HIBENCHMARKS.alarms.notifications_shown.splice(len, 1);
                    len = HIBENCHMARKS.alarms.notifications_shown.length;
                }
            }
            */

            if(show === true) {
                if(typeof HIBENCHMARKS.alarms.notificationCallback === 'function')
                    show = HIBENCHMARKS.alarms.notificationCallback(entry);
                ...
                if(show === true) {
                    setTimeout(function() {
                        ...
                        var n = new Notification(title, {
                            ...
                            icon: HIBENCHMARKS.serverStatic + icon,
                            data: data
                        });

                        n.onclick = function(event) {
                            event.preventDefault();
                            HIBENCHMARKS.alarms.onclick(event.target.data);
                        };

                        // console.log(n);
                        // HIBENCHMARKS.alarms.notifications_shown.push(n);
                        // console.log(entry);
                    }, HIBENCHMARKS.alarms.ms_penalty);

                    HIBENCHMARKS.alarms.ms_penalty += HIBENCHMARKS.alarms.ms_between_notifications;
                }
            }
        },
        ...
        scrollToChart: function(chart_id) {
            if(typeof chart_id === 'string') {
                var offset = $('#' + HIBENCHMARKS.alarms.chart_div_id_prefix + HIBENCHMARKS.name2id(chart_id)).offset();
                if(typeof offset !== 'undefined') {
                    $('html, body').animate({ scrollTop: offset.top + HIBENCHMARKS.alarms.chart_div_offset }, HIBENCHMARKS.alarms.chart_div_animation_duration);
                    return true;
                }
            }
            return false;
        ...
        scrollToAlarm: function(alarm) {
            if(typeof alarm === 'object') {
                var ret = HIBENCHMARKS.alarms.scrollToChart(alarm.chart);

                if(ret === true && HIBENCHMARKS.options.page_is_visible === false)
                    window.focus();
                //    alert('hibenchmarks dashboard will now scroll to chart: ' + alarm.chart + '\n\nThis alarm opened to bring the browser window in front of the screen. Click on the dashboard to prevent it from appearing again.');
            }
        ...
        notifyAll: function() {
            ...
            HIBENCHMARKS.alarms.get_log(HIBENCHMARKS.alarms.last_notification_id, function(data) {
                ...
                HIBENCHMARKS.alarms.ms_penalty = 0;

                var len = data.length;
                while(len--) {
                    if(data[len].unique_id > HIBENCHMARKS.alarms.last_notification_id) {
                        HIBENCHMARKS.alarms.notify(data[len]);
                    }
                    //else
                    //    console.log('ignoring alarm (older) with id ' + data[len].unique_id.toString());
                }

                HIBENCHMARKS.alarms.last_notification_id = data[0].unique_id;

                if(typeof hibenchmarksAlarmsRemember === 'undefined' || hibenchmarksAlarmsRemember === true)
                    HIBENCHMARKS.localStorageSet('last_notification_id', HIBENCHMARKS.alarms.last_notification_id, null);
                // console.log('last notification id = ' + HIBENCHMARKS.alarms.last_notification_id);
            })
        },
        ...
        check_notifications: function() {
            ...
            if(HIBENCHMARKS.alarms.notifications !== true) {
            ...
            if(typeof HIBENCHMARKS.alarms.current !== 'undefined' && typeof HIBENCHMARKS.alarms.current.alarms === 'object') {
                // console.log('can do alarms: old id = ' + HIBENCHMARKS.alarms.last_notification_id + ' new id = ' + HIBENCHMARKS.alarms.current.latest_alarm_log_unique_id);

                if(HIBENCHMARKS.alarms.current.latest_alarm_log_unique_id > HIBENCHMARKS.alarms.last_notification_id) {
        ...
        get: function(what, callback) {
            $.ajax({
                url: HIBENCHMARKS.alarms.server + '/api/v1/alarms?' + what.toString(),
                async: true,
                cache: false,
                headers: {
                    'Cache-Control': 'no-cache, no-store',
                ...
                .done(function(data) {
                    data = HIBENCHMARKS.xss.checkOptional('/api/v1/alarms', data /*, '.*\.(calc|calc_parsed|warn|warn_parsed|crit|crit_parsed)$' */);

                    if(HIBENCHMARKS.alarms.first_notification_id === 0 && typeof data.latest_alarm_log_unique_id === 'number')
                        HIBENCHMARKS.alarms.first_notification_id = data.latest_alarm_log_unique_id;

                    if(typeof callback === 'function')
                        return callback(data);
                })
                .fail(function() {
                    HIBENCHMARKS.error(415, HIBENCHMARKS.alarms.server);
        ...
        update_forever: function() {
            if(hibenchmarksShowAlarms !== true || hibenchmarksSnapshotData !== null)
                return;

            HIBENCHMARKS.alarms.get('active', function(data) {
                if(data !== null) {
                    HIBENCHMARKS.alarms.current = data;

                    if(HIBENCHMARKS.alarms.check_notifications() === true) {
                        HIBENCHMARKS.alarms.notifyAll();
                    }

                    if (typeof HIBENCHMARKS.alarms.callback === 'function') {
                        HIBENCHMARKS.alarms.callback(data);
                    }

                    // Health monitoring is disabled on this hibenchmarks
                    if(data.status === false) return;
                }

                setTimeout(HIBENCHMARKS.alarms.update_forever, HIBENCHMARKS.alarms.update_every);
            });
        },
        ...
        get_log: function(last_id, callback) {
            ...
            $.ajax({
                url: HIBENCHMARKS.alarms.server + '/api/v1/alarm_log?after=' + last_id.toString(),
                async: true,
                cache: false,
                headers: {
                    'Cache-Control': 'no-cache, no-store',
                ...
                .done(function(data) {
                    data = HIBENCHMARKS.xss.checkOptional('/api/v1/alarm_log', data);

                    if(typeof callback === 'function')
                        return callback(data);
                })
                .fail(function() {
                    HIBENCHMARKS.error(416, HIBENCHMARKS.alarms.server);
        ...
        init: function() {
            HIBENCHMARKS.alarms.server = HIBENCHMARKS.fixHost(HIBENCHMARKS.serverDefault);

            if(typeof hibenchmarksAlarmsRemember === 'undefined' || hibenchmarksAlarmsRemember === true) {
                HIBENCHMARKS.alarms.last_notification_id =
                    HIBENCHMARKS.localStorageGet('last_notification_id', HIBENCHMARKS.alarms.last_notification_id, null);
            }

            if(HIBENCHMARKS.alarms.onclick === null)
                HIBENCHMARKS.alarms.onclick = HIBENCHMARKS.alarms.scrollToAlarm;

            if(typeof hibenchmarksAlarmsRecipients !== 'undefined' && Array.isArray(hibenchmarksAlarmsRecipients))
                HIBENCHMARKS.alarms.recipients = hibenchmarksAlarmsRecipients;

            if(hibenchmarksShowAlarms === true) {
                HIBENCHMARKS.alarms.update_forever();
            
                if('Notification' in window) {
                    // console.log('notifications available');
                    HIBENCHMARKS.alarms.notifications = true;
    ...
    HIBENCHMARKS.registry = {
        server: null,         // the hibenchmarks registry server
        person_guid: null,    // the unique ID of this browser / user
        machine_guid: null,   // the unique ID the hibenchmarks server that served dashboard.js
        hostname: 'unknown',  // the hostname of the hibenchmarks server that served dashboard.js
        ...
        parsePersonUrls: function(person_urls) {
            ...
            HIBENCHMARKS.registry.person_urls = person_urls;

            if(person_urls) {
                HIBENCHMARKS.registry.machines = {};
                HIBENCHMARKS.registry.machines_array = [];

                var apu = person_urls;
                var i = apu.length;
                while(i--) {
                    if(typeof HIBENCHMARKS.registry.machines[apu[i][0]] === 'undefined') {
                        ...
                        HIBENCHMARKS.registry.machines[apu[i][0]] = obj;
                        HIBENCHMARKS.registry.machines_array.push(obj);
                    }
                    else {
                        // console.log('appending: ' + apu[i][4] + ', ' + ((now - apu[i][2]) / 1000).toString());

                        var pu = HIBENCHMARKS.registry.machines[apu[i][0]];
            ...
            if(typeof hibenchmarksRegistryCallback === 'function')
                hibenchmarksRegistryCallback(HIBENCHMARKS.registry.machines_array);
        },

        init: function() {
            if(hibenchmarksRegistry !== true) return;

            HIBENCHMARKS.registry.hello(HIBENCHMARKS.serverDefault, function(data) {
                if(data) {
                    HIBENCHMARKS.registry.server = data.registry;
                    HIBENCHMARKS.registry.machine_guid = data.machine_guid;
                    HIBENCHMARKS.registry.hostname = data.hostname;

                    HIBENCHMARKS.registry.access(2, function (person_urls) {
                        HIBENCHMARKS.registry.parsePersonUrls(person_urls);
        ...
        hello: function(host, callback) {
            ...
            // send HELLO to a hibenchmarks server:
            // 1. verifies the server is reachable
            // 2. responds with the registry URL, the machine GUID of this hibenchmarks server and its hostname
            $.ajax({
                ...
                .done(function(data) {
                    data = HIBENCHMARKS.xss.checkOptional('/api/v1/registry?action=hello', data);

                    if(typeof data.status !== 'string' || data.status !== 'ok') {
                        HIBENCHMARKS.error(408, host + ' response: ' + JSON.stringify(data));
                        data = null;
                    }
        ...
        access: function(max_redirects, callback) {
            // send ACCESS to a hibenchmarks registry:
            // 1. it lets it know we are accessing a hibenchmarks server (its machine GUID and its URL)
            // 2. it responds with a list of hibenchmarks servers we know
            ...
            $.ajax({
                    url: HIBENCHMARKS.registry.server + '/api/v1/registry?action=access&machine=' + HIBENCHMARKS.registry.machine_guid + '&name=' + encodeURIComponent(HIBENCHMARKS.registry.hostname) + '&url=' + encodeURIComponent(HIBENCHMARKS.serverDefault), // + '&visible_url=' + encodeURIComponent(document.location),
                    async: true,
                    cache: false,
                    headers: {
                        'Cache-Control': 'no-cache, no-store',
                ...
                .done(function(data) {
                    data = HIBENCHMARKS.xss.checkAlways('/api/v1/registry?action=access', data);
                    ...
                    if(typeof data.status !== 'string' || data.status !== 'ok') {
                        HIBENCHMARKS.error(409, HIBENCHMARKS.registry.server + ' responded with: ' + JSON.stringify(data));
                        data = null;
                    }

                    if(data === null) {
                        if(redirect !== null && max_redirects > 0) {
                            HIBENCHMARKS.registry.server = redirect;
                            HIBENCHMARKS.registry.access(max_redirects - 1, callback);
                        }
                        else {
                            if(typeof callback === 'function')
                                return callback(null);
                        ...
                        if(typeof data.person_guid === 'string')
                            HIBENCHMARKS.registry.person_guid = data.person_guid;
                ...
                .fail(function() {
                    HIBENCHMARKS.error(410, HIBENCHMARKS.registry.server);
        ...
        delete: function(delete_url, callback) {
            // send DELETE to a hibenchmarks registry:
            $.ajax({
                url: HIBENCHMARKS.registry.server + '/api/v1/registry?action=delete&machine=' + HIBENCHMARKS.registry.machine_guid + '&name=' + encodeURIComponent(HIBENCHMARKS.registry.hostname) + '&url=' + encodeURIComponent(HIBENCHMARKS.serverDefault) + '&delete_url=' + encodeURIComponent(delete_url),
                async: true,
                cache: false,
                headers: {
                    'Cache-Control': 'no-cache, no-store',
                ...
                .done(function(data) {
                    data = HIBENCHMARKS.xss.checkAlways('/api/v1/registry?action=delete', data);

                    if(typeof data.status !== 'string' || data.status !== 'ok') {
                        HIBENCHMARKS.error(411, HIBENCHMARKS.registry.server + ' responded with: ' + JSON.stringify(data));
                        data = null;
                    }
                ...
                .fail(function() {
                    HIBENCHMARKS.error(412, HIBENCHMARKS.registry.server);
        ...
        search: function(machine_guid, callback) {
            ...
            $.ajax({
                url: HIBENCHMARKS.registry.server + '/api/v1/registry?action=search&machine=' + HIBENCHMARKS.registry.machine_guid + '&name=' + encodeURIComponent(HIBENCHMARKS.registry.hostname) + '&url=' + encodeURIComponent(HIBENCHMARKS.serverDefault) + '&for=' + machine_guid,
                async: true,
                cache: false,
                headers: {
                    'Cache-Control': 'no-cache, no-store',
                ...
                .done(function(data) {
                    data = HIBENCHMARKS.xss.checkAlways('/api/v1/registry?action=search', data);

                    if(typeof data.status !== 'string' || data.status !== 'ok') {
                        HIBENCHMARKS.error(417, HIBENCHMARKS.registry.server + ' responded with: ' + JSON.stringify(data));
                        data = null;
                    }
                ...
                .fail(function() {
                    HIBENCHMARKS.error(418, HIBENCHMARKS.registry.server);
        ...
        switch: function(new_person_guid, callback) {
            // impersonate
            $.ajax({
                url: HIBENCHMARKS.registry.server + '/api/v1/registry?action=switch&machine=' + HIBENCHMARKS.registry.machine_guid + '&name=' + encodeURIComponent(HIBENCHMARKS.registry.hostname) + '&url=' + encodeURIComponent(HIBENCHMARKS.serverDefault) + '&to=' + new_person_guid,
                async: true,
                cache: false,
                headers: {
                    'Cache-Control': 'no-cache, no-store',
                ...
                .done(function(data) {
                    data = HIBENCHMARKS.xss.checkAlways('/api/v1/registry?action=switch', data);

                    if(typeof data.status !== 'string' || data.status !== 'ok') {
                        HIBENCHMARKS.error(413, HIBENCHMARKS.registry.server + ' responded with: ' + JSON.stringify(data));
                        data = null;
                    }
                ...
                .fail(function() {
                    HIBENCHMARKS.error(414, HIBENCHMARKS.registry.server);
    ...
    if(typeof hibenchmarksPrepCallback === 'function')
        hibenchmarksPrepCallback();

    HIBENCHMARKS.errorReset();
    HIBENCHMARKS.loadRequiredCSS(0);

    HIBENCHMARKS._loadjQuery(function() {
        HIBENCHMARKS.loadRequiredJs(0, function() {
            if(typeof $().emulateTransitionEnd !== 'function') {
                // bootstrap is not available
                HIBENCHMARKS.options.current.show_help = false;
            }

            if(typeof hibenchmarksDontStart === 'undefined' || !hibenchmarksDontStart) {
                if(HIBENCHMARKS.options.debug.main_loop === true)
