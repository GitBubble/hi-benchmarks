# -*- coding: utf-8 -*-
# Description: isc dhcpd lease hibenchmarks python.d module
# Author: l2isbad
...
class Service(SimpleService):
    ...
    def check(self):
        ...
        if not self.dhcpd_leases.is_valid():
            self.error("Make sure '{path}' is exist and readable by hibenchmarks".format(path=self.dhcpd_leases.path))
            return False
