...
through a CDN, to allow hibenchmarks to work in cases where internet
...
- [Utilities for writing code that runs on Python 2 and 3](https://github.com/firehol/hibenchmarks/blob/master/python.d/python_modules/urllib3/packages/six.py)

    Copyright (c) 2010-2015 Benjamin Peterson
    [MIT License](https://github.com/firehol/hibenchmarks/blob/master/python.d/python_modules/urllib3/packages/six.py)
