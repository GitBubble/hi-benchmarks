...
#ifndef HIBENCHMARKS_COMMON_H
#define HIBENCHMARKS_COMMON_H 1
...
// ----------------------------------------------------------------------------
// system include files for all hibenchmarks C programs
...
#define HIBENCHMARKS_CHART_PRIO_SYSTEM_IPV4             501

// Memory Section - 1xxx
#define HIBENCHMARKS_CHART_PRIO_MEM_SYSTEM              1000
#define HIBENCHMARKS_CHART_PRIO_MEM_SYSTEM_AVAILABLE    1010
#define HIBENCHMARKS_CHART_PRIO_MEM_SYSTEM_COMMITTED    1020
#define HIBENCHMARKS_CHART_PRIO_MEM_SYSTEM_PGFAULTS     1030
#define HIBENCHMARKS_CHART_PRIO_MEM_KERNEL              1100
#define HIBENCHMARKS_CHART_PRIO_MEM_SLAB                1200
#define HIBENCHMARKS_CHART_PRIO_MEM_HUGEPAGES           1250
#define HIBENCHMARKS_CHART_PRIO_MEM_KSM                 1300
#define HIBENCHMARKS_CHART_PRIO_MEM_NUMA                1400
#define HIBENCHMARKS_CHART_PRIO_MEM_HW                  1500


// IPv4

#define HIBENCHMARKS_CHART_PRIO_IPV4                    3000
#define HIBENCHMARKS_CHART_PRIO_IPV4_SOCKETS            3000
#define HIBENCHMARKS_CHART_PRIO_IPV4_PACKETS            3050
#define HIBENCHMARKS_CHART_PRIO_IPV4_ERRORS             3100

#define HIBENCHMARKS_CHART_PRIO_IPV4_ICMP               3150

#define HIBENCHMARKS_CHART_PRIO_IPV4_TCP                3200
#define HIBENCHMARKS_CHART_PRIO_IPV4_TCP_MEM            3290

#define HIBENCHMARKS_CHART_PRIO_IPV4_UDP                3300
#define HIBENCHMARKS_CHART_PRIO_IPV4_UDP_MEM            3390

#define HIBENCHMARKS_CHART_PRIO_IPV4_UDPLITE            3400

#define HIBENCHMARKS_CHART_PRIO_IPV4_RAW                3450

#define HIBENCHMARKS_CHART_PRIO_IPV4_FRAGMENTS          3460
#define HIBENCHMARKS_CHART_PRIO_IPV4_FRAGMENTS_MEM      3470

#define HIBENCHMARKS_CHART_PRIO_IPV4_BCAST              3500
#define HIBENCHMARKS_CHART_PRIO_IPV4_MCAST              3600
#define HIBENCHMARKS_CHART_PRIO_IPV4_ECN                3700

// IPv6

#define HIBENCHMARKS_CHART_PRIO_IPV6                    3500

// SCTP

#define HIBENCHMARKS_CHART_PRIO_SCTP                    3600

// Netfilter

#define HIBENCHMARKS_CHART_PRIO_NETFILTER               3700
#define HIBENCHMARKS_CHART_PRIO_SYNPROXY                3750


// ----------------------------------------------------------------------------
// hibenchmarks common definitions
...
#define HIBENCHMARKS_OS_TYPE "freebsd"
...
extern char *hibenchmarks_configured_hostname;
extern char *hibenchmarks_configured_config_dir;
extern char *hibenchmarks_configured_log_dir;
extern char *hibenchmarks_configured_plugins_dir_base;
extern char *hibenchmarks_configured_plugins_dir;
extern char *hibenchmarks_configured_web_dir;
extern char *hibenchmarks_configured_cache_dir;
extern char *hibenchmarks_configured_varlib_dir;
extern char *hibenchmarks_configured_home_dir;
extern char *hibenchmarks_configured_host_prefix;
extern char *hibenchmarks_configured_timezone;

extern void hibenchmarks_fix_chart_id(char *s);
extern void hibenchmarks_fix_chart_name(char *s);
...
#ifdef HIBENCHMARKS_LOG_ALLOCATIONS
...
extern int verify_hibenchmarks_host_prefix();
...
extern volatile sig_atomic_t hibenchmarks_exit;
