...
void *backends_main(void *ptr) {
    ...
    RRDSET *chart_metrics = rrdset_create_localhost("hibenchmarks", "backend_metrics", NULL, "backend", NULL, "Netdata Buffered Metrics", "metrics", "backends", NULL, 130600, backend_update_every, RRDSET_TYPE_LINE);
    ...
    RRDSET *chart_bytes = rrdset_create_localhost("hibenchmarks", "backend_bytes", NULL, "backend", NULL, "Netdata Backend Data Size", "KB", "backends", NULL, 130610, backend_update_every, RRDSET_TYPE_AREA);
    ...
    RRDSET *chart_ops = rrdset_create_localhost("hibenchmarks", "backend_ops", NULL, "backend", NULL, "Netdata Backend Operations", "operations", "backends", NULL, 130630, backend_update_every, RRDSET_TYPE_LINE);
     ...
     *
    RRDSET *chart_latency = rrdset_create_localhost("hibenchmarks", "backend_latency", NULL, "backend", NULL, "Netdata Backend Latency", "ms", "backends", NULL, 130620, backend_update_every, RRDSET_TYPE_AREA);
