...
/*
 * 1. build hibenchmarks (as normally)
 * 2. cd profile/
 * 3. compile with:
 *    gcc -g -ggdb -Wall -Wextra -I ../src/ -I ../ -o test-eval test-eval.c ../src/log.o ../src/eval.o ../src/common.o ../src/clocks.o ../src/web_buffer.o ../src/storage_number.o -pthread -lm
 */
