...
#ifndef HIBENCHMARKS_ADAPTIVE_RESORTABLE_LIST_H
#define HIBENCHMARKS_ADAPTIVE_RESORTABLE_LIST_H

/*
 * ADAPTIVE RE-SORTABLE LIST
 * This structure allows hibenchmarks to read a file of NAME VALUE lines
...
#endif //HIBENCHMARKS_ADAPTIVE_RESORTABLE_LIST_H
