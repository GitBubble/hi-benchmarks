...
#ifndef HIBENCHMARKS_REGISTRY_H
#define HIBENCHMARKS_REGISTRY_H 1

#define HIBENCHMARKS_REGISTRY_COOKIE_NAME "hibenchmarks_registry_id"

// initialize the registry
// should only happen when hibenchmarks starts
extern int registry_init(void);

// free all data held by the registry
// should only happen when hibenchmarks exits
