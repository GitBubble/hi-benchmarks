...
#ifndef HIBENCHMARKS_HEALTH_H
#define HIBENCHMARKS_HEALTH_H
...
// They increase the overhead of hibenchmarks.
//
...
typedef struct alarm_log {
    ...
    unsigned int max;
    ALARM_ENTRY *alarms;
    hibenchmarks_rwlock_t alarm_log_rwlock;
} ALARM_LOG;
...
#ifdef HIBENCHMARKS_HEALTH_INTERNALS
...
#endif // HIBENCHMARKS_HEALTH_INTERNALS

#endif //HIBENCHMARKS_HEALTH_H
