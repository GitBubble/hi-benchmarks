...
#ifndef HIBENCHMARKS_SOCKET_H
#define HIBENCHMARKS_SOCKET_H
...
typedef struct listen_sockets {
    const char *config_section;         // the hibenchmarks configuration section to read settings from
