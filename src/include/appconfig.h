...
#ifndef HIBENCHMARKS_CONFIG_H
#define HIBENCHMARKS_CONFIG_H 1

#define CONFIG_FILENAME "hibenchmarks.conf"
...
// ----------------------------------------------------------------------------
// shortcuts for the default hibenchmarks configuration

#define config_load(filename, overwrite_used) appconfig_load(&hibenchmarks_config, filename, overwrite_used)
#define config_get(section, name, default_value) appconfig_get(&hibenchmarks_config, section, name, default_value)
#define config_get_number(section, name, value) appconfig_get_number(&hibenchmarks_config, section, name, value)
#define config_get_float(section, name, value) appconfig_get_float(&hibenchmarks_config, section, name, value)
#define config_get_boolean(section, name, value) appconfig_get_boolean(&hibenchmarks_config, section, name, value)
#define config_get_boolean_ondemand(section, name, value) appconfig_get_boolean_ondemand(&hibenchmarks_config, section, name, value)

#define config_set(section, name, default_value) appconfig_set(&hibenchmarks_config, section, name, default_value)
#define config_set_default(section, name, value) appconfig_set_default(&hibenchmarks_config, section, name, value)
#define config_set_number(section, name, value) appconfig_set_number(&hibenchmarks_config, section, name, value)
#define config_set_float(section, name, value) appconfig_set_float(&hibenchmarks_config, section, name, value)
#define config_set_boolean(section, name, value) appconfig_set_boolean(&hibenchmarks_config, section, name, value)

#define config_exists(section, name) appconfig_exists(&hibenchmarks_config, section, name)
#define config_move(section_old, name_old, section_new, name_new) appconfig_move(&hibenchmarks_config, section_old, name_old, section_new, name_new)

#define config_generate(buffer, only_changed) appconfig_generate(&hibenchmarks_config, buffer, only_changed)

#endif /* HIBENCHMARKS_CONFIG_H */
