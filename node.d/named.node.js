...
// example configuration in /etc/hibenchmarks/node.d/named.conf
...
if(hibenchmarks.options.DEBUG === true) hibenchmarks.debug('loaded', __filename, 'plugin');
...
var named = {
        ...
        for(var i = 0; i < len ;i++) {
            ...
            if(typeof(obj[x]) !== 'undefined' && obj[x] !== 0) {
                ...
                chart.dimensions[x] = {
                    ...
                    algorithm: algorithm,   // the id of the hibenchmarks algorithm
    ...
    processResponse: function(service, data) {
        if(data !== null) {
            ...
            if(typeof r.nsstats !== 'undefined') {
                ...
                while(len--) {
                    ...
                    if(typeof look === 'undefined') {
                        ...
                        look = named.lookups.nsstats[x];
                        // hibenchmarks.error('lookup nsstats value: ' + x + ' >>> ' + named.lookups.nsstats[x].type);
                    }
                ...
                if(global_requests_enable === true)
                    service.module.chartFromMembers(service, global_requests, 'received_requests', 'Bind, Global Received Requests by IP version', 'requests/s', 'requests', 'named.requests', hibenchmarks.chartTypes.stacked, named.base_priority + 1, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                if(global_queries_success_enable === true)
                    service.module.chartFromMembers(service, global_queries_success, 'global_queries_success', 'Bind, Global Successful Queries', 'queries/s', 'queries', 'named.queries_succcess', hibenchmarks.chartTypes.line, named.base_priority + 2, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                if(protocol_queries_enable === true)
                    service.module.chartFromMembers(service, protocol_queries, 'protocols_queries', 'Bind, Global Queries by IP Protocol', 'queries/s', 'queries', 'named.protocol_queries', hibenchmarks.chartTypes.stacked, named.base_priority + 3, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                if(global_queries_enable === true)
                    service.module.chartFromMembers(service, global_queries, 'global_queries', 'Bind, Global Queries Analysis', 'queries/s', 'queries', 'named.global_queries', hibenchmarks.chartTypes.stacked, named.base_priority + 4, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                if(global_updates_enable === true)
                    service.module.chartFromMembers(service, global_updates, 'received_updates', 'Bind, Global Received Updates', 'updates/s', 'updates', 'named.global_updates', hibenchmarks.chartTypes.stacked, named.base_priority + 5, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                if(global_failures_enable === true)
                    service.module.chartFromMembers(service, global_failures, 'query_failures', 'Bind, Global Query Failures', 'failures/s', 'failures', 'named.global_failures', hibenchmarks.chartTypes.line, named.base_priority + 6, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                if(global_failures_detail_enable === true)
                    service.module.chartFromMembers(service, global_failures_detail, 'query_failures_detail', 'Bind, Global Query Failures Analysis', 'failures/s', 'failures', 'named.global_failures_detail', hibenchmarks.chartTypes.stacked, named.base_priority + 7, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                if(default_enable === true)
                    service.module.chartFromMembers(service, r.nsstats, 'nsstats', 'Bind, Other Global Server Statistics', 'operations/s', 'other', 'named.nsstats', hibenchmarks.chartTypes.line, named.base_priority + 8, hibenchmarks.chartAlgorithms.incremental, 1, 1);
                ...
                if(typeof chart === 'undefined') {
                    chart = {
                        ...
                        type: hibenchmarks.chartTypes.line,                  // the type of the chart
                        ...
                        dimensions: {
                            'clients': {
                                ...
                                algorithm: hibenchmarks.chartAlgorithms.absolute,// the id of the hibenchmarks algorithm
            ...
            if(typeof r.opcodes !== 'undefined')
                service.module.chartFromMembers(service, r.opcodes, 'in_opcodes', 'Bind, Global Incoming Requests by OpCode', 'requests/s', 'requests', 'named.in_opcodes', hibenchmarks.chartTypes.stacked, named.base_priority + 9, hibenchmarks.chartAlgorithms.incremental, 1, 1);

            if(typeof r.qtypes !== 'undefined')
                service.module.chartFromMembers(service, r.qtypes, 'in_qtypes', 'Bind, Global Incoming Requests by Query Type', 'requests/s', 'requests', 'named.in_qtypes', hibenchmarks.chartTypes.stacked, named.base_priority + 10, hibenchmarks.chartAlgorithms.incremental, 1, 1);

            if(typeof r.sockstats !== 'undefined')
                service.module.chartFromMembers(service, r.sockstats, 'in_sockstats', 'Bind, Global Socket Statistics', 'operations/s', 'sockets', 'named.in_sockstats', hibenchmarks.chartTypes.line, named.base_priority + 11, hibenchmarks.chartAlgorithms.incremental, 1, 1);
            ...
            if(typeof r.views !== 'undefined') {
                ...
                while(len--) {
                        ...
                        if(typeof resolver.stats !== 'undefined') {
                            ...
                            while(ylen--) {
                                ...
                                if(typeof look === 'undefined') {
                                    ...
                                    look = named.lookups.resolver_stats[y];
                                    // hibenchmarks.error('lookup resolver stats value: ' + y + ' >>> ' + look.type);
                                }
                            ...
                            if(rtt_enable)
                                service.module.chartFromMembers(service, rtt, 'view_resolver_rtt_' + x, 'Bind, ' + x + ' View, Resolver Round Trip Timings', 'queries/s', 'view_' + x, 'named.resolver_rtt', hibenchmarks.chartTypes.stacked, named.base_priority + 12, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                            if(default_enable)
                                service.module.chartFromMembers(service, resolver.stats, 'view_resolver_stats_' + x, 'Bind, ' + x + ' View, Resolver Statistics', 'operations/s', 'view_' + x, 'named.resolver_stats', hibenchmarks.chartTypes.line, named.base_priority + 13, hibenchmarks.chartAlgorithms.incremental, 1, 1);
                    ...
                    if(typeof resolver.qtypes !== 'undefined')
                        service.module.chartFromMembers(service, resolver.qtypes, 'view_resolver_qtypes_' + x, 'Bind, ' + x + ' View, Requests by Query Type', 'requests/s', 'view_' + x, 'named.resolver_qtypes', hibenchmarks.chartTypes.stacked, named.base_priority + 14, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                    //if(typeof resolver.cache !== 'undefined')
                    //  service.module.chartFromMembers(service, resolver.cache, 'view_resolver_cache_' + x, 'Bind, ' + x + ' View, Cache Entries', 'entries', 'view_' + x, 'named.resolver_cache', hibenchmarks.chartTypes.stacked, named.base_priority + 15, hibenchmarks.chartAlgorithms.absolute, 1, 1);
                    ...
                    if(typeof resolver.cachestats['CacheHits'] !== 'undefined' && resolver.cachestats['CacheHits'] > 0) {
                        ...
                        if(typeof chart === 'undefined') {
                            chart = {
                                ...
                                type: hibenchmarks.chartTypes.area,                  // the type of the chart
                                ...
                                dimensions: {
                                    'CacheHits': {
                                        ...
                                        algorithm: hibenchmarks.chartAlgorithms.incremental,// the id of the hibenchmarks algorithm
                                        multiplier: 1,                              // the multiplier
                                        divisor: 1,                                 // the divisor
                                        hidden: false                               // is hidden (boolean)
                                    },
                    ...
                    //  service.module.chartFromMembers(service, resolver.cachestats, 'view_resolver_cachestats_' + x, 'Bind, ' + x + ' View, Cache Statistics', 'requests/s', 'view_' + x, 'named.resolver_cache_stats', hibenchmarks.chartTypes.line, named.base_priority + 1001, hibenchmarks.chartAlgorithms.incremental, 1, 1);

                    //if(typeof resolver.adb !== 'undefined')
                    //  service.module.chartFromMembers(service, resolver.adb, 'view_resolver_adb_' + x, 'Bind, ' + x + ' View, ADB Statistics', 'entries', 'view_' + x, 'named.resolver_adb', hibenchmarks.chartTypes.line, named.base_priority + 1002, hibenchmarks.chartAlgorithms.absolute, 1, 1);
                }
            }
        }
    },
    ...
    // hibenchmarks.serviceExecute()
    serviceExecute: function(name, a_url, update_every) {
        if(hibenchmarks.options.DEBUG === true) hibenchmarks.debug(this.name + ': ' + name + ': url: ' + a_url + ', update_every: ' + update_every);
        var service = hibenchmarks.service({
            name: name,
            request: hibenchmarks.requestFromURL(a_url),
