...
#ifndef HIBENCHMARKS_WEB_SERVER_H
#define HIBENCHMARKS_WEB_SERVER_H 1
...
extern SIMPLE_PATTERN *web_allow_hibenchmarksconf_from;
...
#endif /* HIBENCHMARKS_WEB_SERVER_H */
