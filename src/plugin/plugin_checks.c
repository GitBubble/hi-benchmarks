...
void *checks_main(void *ptr) {
    hibenchmarks_thread_cleanup_push(checks_main_cleanup, ptr);
    ...
    rrddim_add(check3, "hibenchmarks", NULL, 1, 1, RRD_ALGORITHM_ABSOLUTE);
    ...
    while(!hibenchmarks_exit) {
        ...
        rrddim_set(check3, "hibenchmarks", (long long) dt_usec(&loop, &check2->last_collected_time));
