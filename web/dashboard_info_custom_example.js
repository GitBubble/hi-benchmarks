...
/*
 * Custom hibenchmarks information file
 * -------------------------------
 *
 * Use this file to add custom information on hibenchmarks dashboards:
 *
 * 1. Copy it to a new filename (so that it will not be overwritten with hibenchmarks updates)
 * 2. Edit it to fit your needs
 * 3. Set the following option to /etc/hibenchmarks/hibenchmarks.conf :
 *
 *    [web]
 ...
 *
 * 2. Inject javascript code into the default hibenchmarks dashboard.
 *
 */
